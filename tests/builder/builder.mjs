...
ok(script.includes("import 'core-js/modules/esnext.array-buffer.detached.js';"), 'actual node 16 #3');
...
ok(!script.includes("import 'core-js/modules/esnext.array.from-async.js';"), 'actual node 16 #7');
