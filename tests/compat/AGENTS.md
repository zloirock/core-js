...
- `compat-data.js` and `rhino.jar` are generated or fetched and gitignored; the `*-adapter.mjs` files, `common-runner.js`, `index.html` and `metadata.json` are runner plumbing
