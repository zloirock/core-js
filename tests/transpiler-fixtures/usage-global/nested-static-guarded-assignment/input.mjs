...
let result;
try {
  ({ Array: { [(events.push('key'), 'from')]: from }, [(events.push('x'.at(0), typeof from), 'Object')]: { keys } }
...
let method = 'old';
try {
  ({ Array: { [(events.push('partial'), 'from')]: method },
    Object: { keys: box[(events.push(method === pureFrom, 'y'.at(0)), 'value')] } }
