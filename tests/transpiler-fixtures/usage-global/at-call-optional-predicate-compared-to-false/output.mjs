...
// of what `tsc` narrows (it reads the comparison two-valued and says `string`), because the string
// helper on the array the skipped predicate let through throws at runtime. compared against `true`
// the truthy side proves the call ran and narrows
declare const obj: {
