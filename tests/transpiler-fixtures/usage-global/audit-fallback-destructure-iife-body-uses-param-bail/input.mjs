...
// over-emission - the constructor is still the file's own, held in a slot the call yielded, so it
// owes no family either. regression guard against future over-eager peel attempts.
