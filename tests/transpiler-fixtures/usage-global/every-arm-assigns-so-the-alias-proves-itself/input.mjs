...
// this flavor keeps every call site and injects a side-effect import, so the negatives read the same
// here as the positives do: what it pins is that the resolution WIDENS on this shape rather than
// bailing, and the twin file is where the receiver-less rewrite is visible
