...
export const spineCallBeforeArg = globalThis.window?.self.Object.keys({ a: 1 }).at(globalThis.window?.self.Math.round(0.4));
...
export const nestedNavPlainTail = globalThis.window?.self.Object.keys({ b: 2 }).pop(globalThis.window?.self.Math.round(0.4));
export const nestedNavOpaqueStatic = globalThis.window?.self.JSON.stringify({ c: 3 }).at(globalThis.window?.self.Math.round(0.4));
