...
export function viaInit(input) { const out = pick(input.of); return typeof out; }
export function viaAssign(input) { let out; out = pick(input.isArray); return typeof out; }
