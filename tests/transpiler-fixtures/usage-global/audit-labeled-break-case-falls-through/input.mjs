...
type Box = { kind: "a"; body: number[]; } | { kind: "b"; body: string; };
type Crate = { tag: "x"; items: number[]; } | { tag: "y"; items: string; };
declare const box: Box;
declare const crate: Crate;

switch (box.kind) {
  case "a": outer: { break outer; throw 0; }
  case "b": box.body.at(0);
}

switch (crate.tag) {
  case "x": guarded: { throw 0; }
  case "y": crate.items.includes("a");
}
