...
// (`from` is a static on the Array constructor, not on the prototype). no polyfillable static is
// reachable this way, so the call is left untouched (injecting a static `from` would be wrong; the
