...
globalThis.chainBox = { n: 4, list: ['ab', 'cd'] };
export const chained = (globalThis.window?.self.chainBox.list, globalThis.window?.self.chainBox.list)
  ?.at(0).includes('a');
...
export const triple = (globalThis.window?.self.chainBox.list, globalThis.window?.self.chainBox.list,
  globalThis.window?.self.chainBox.list)?.at(0);
...
export const deepChain = (globalThis.window?.self.chainBox.list, globalThis.window?.self.chainBox.list)
  ?.at(0)?.slice(1).slice(1).slice(1).includes('a');
export const deepNest = globalThis.window?.self.chainBox.list?.at(0)
  ?.slice(globalThis.window?.self.chainBox.list?.at(1)
    ?.slice(globalThis.window?.self.chainBox.list?.at(0)?.length ?? 0).length ?? 0).includes('a');
