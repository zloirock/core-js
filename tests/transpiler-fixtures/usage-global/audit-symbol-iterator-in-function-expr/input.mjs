// `Symbol.iterator in <function expression>` - functions don't carry iterator at runtime,
// but plugin treats `Symbol.iterator in <RHS>` as polyfill trigger regardless of RHS shape.
// covers the function-expression-as-RHS case; full iterator polyfill suite registered
