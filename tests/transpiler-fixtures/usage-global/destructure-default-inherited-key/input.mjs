...
export const viaConstructor = C.from([1]);
const { toString: T = Object } = {};
export const viaToString = T.groupBy([1], x => x);
const { __proto__: P = String } = {};
export const viaPrototype = P.raw`x`;
