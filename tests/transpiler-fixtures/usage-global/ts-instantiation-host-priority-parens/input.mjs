...
export const r = [hostCall, hostNew, hostNewBareArgs, hostOptionalMember, hostOptionalCall, hostTaggedTag, hostMember, hostComputedMember,
  hostConditionalTest, tailValue, tailArgument, tailElement, tailFusingCast, tailFusingAssertion,
  tailFusingUpdate, [1, [2]].flat()];
