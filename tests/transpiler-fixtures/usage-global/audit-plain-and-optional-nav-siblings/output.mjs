...
export const handWrittenGuardFirst = (null == globalThis.window ? void 0 : globalThis.self.siblingBox.list, globalThis.window?.self.siblingBox.list)?.at(0);
export const handWrittenGuardSecond = (globalThis.window?.self.siblingBox.list, null == globalThis.window ? void 0 : globalThis.self.siblingBox.list)?.at(0);
export const tripleRepeat = (globalThis.window?.self.siblingBox.list, globalThis.window?.self.siblingBox.list, globalThis.window?.self.siblingBox.list)?.at(0);
