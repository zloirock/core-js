...
// expansion. babel's adapter routes through `findTSRuntimeBindingInPath`; unplugin's
// `declaresRequireBinding` must enumerate TSEnumDeclaration / TSModuleDeclaration
