...
export const r = [viaArrow, viaConditional, viaAssign, viaBinary, viaLogical, viaUnary, viaPostfix,
  viaPrefix, viaOptionalMember, viaOptionalCall, viaCast, viaBare, viaMember, viaNonNull, viaSequence];