...
const { missObject = null == _globalThis.window ? void 0 : _self.ctorBox.n } = {};
const [missArray = null == (_ref = _globalThis.window) ? void 0 : _at(_ref2 = _ref.ctorBox.list).call(_ref2, 0)] = [];
const { deep: { missNested = null == _globalThis.window ? void 0 : _self.ctorBox.n } = {} } = {};
function withParamDefault({ missParam = null == (_ref3 = null == _globalThis.window ? void 0 : _self.ctorBox.list) ? void 0 : _at(_ref3).call(_ref3, 0) } = {}) {
  return missParam;
}
