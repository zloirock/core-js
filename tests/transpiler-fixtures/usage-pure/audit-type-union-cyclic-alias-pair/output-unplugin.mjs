...
export function bothHalvesOfACyclicPair() {
  if (pair.kind === "a") { var _ref; return _atMaybeArray(_ref = pair.items).call(_ref, 0); }
  return "";
}

// the cycle is reached THROUGH a union alias rather than directly
export function cycleReachedThroughAUnionAlias() {
  if (viaUnion.kind === "a") { var _ref2; return _includesMaybeArray(_ref2 = _entries(viaUnion)).call(_ref2, "x"); }
  return false;
}