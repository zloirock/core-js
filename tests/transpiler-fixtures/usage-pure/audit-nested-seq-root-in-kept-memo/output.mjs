...
export const ctorStaticClaim = null == (_ref4 = (d++, c++, _globalThis)) ? void 0 : _nameMaybeFunction(_Map);
export const ctorStaticOverNav = null == (_ref5 = (d++, c++, _globalThis)) ? void 0 : _nameMaybeFunction(_Map);
