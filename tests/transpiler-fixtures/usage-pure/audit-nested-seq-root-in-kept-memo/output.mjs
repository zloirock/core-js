...
export const nestedSeqNavRoot = null == (_ref3 = (d++, c++, _self)) ? void 0 : _atMaybeArray(_ref3.Array.prototype);
export const tripleNested = null == (_ref4 = (d++, c++, d++, _globalThis)) ? void 0 : _atMaybeArray(_ref4.Array.prototype);
...
export const windowRootNav = null == (_ref5 = (d++, c++, _self)) ? void 0 : _atMaybeArray(_ref5.Array.prototype);
