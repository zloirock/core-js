...
var typedNarrowing = _atMaybeArray(_ref8 = ['ab', 'cd']).call(_ref8, (null == _globalThis.window ? void 0 : _self.scriptBox.list) ? 0 : 1) != null && _includesMaybeString(_ref9 = _atMaybeArray(_ref10 = ['ab', 'cd']).call(_ref10, 0)).call(_ref9, 'a');
