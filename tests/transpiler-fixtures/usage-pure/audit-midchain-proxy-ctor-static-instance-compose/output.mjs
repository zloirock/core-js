...
export const b = _padStartMaybeString(_ref2 = _nameMaybeFunction((eff(), _Set))).call(_ref2, 5);
export const c = _includes(_ref3 = _nameMaybeFunction(_Promise)).call(_ref3, 'P');