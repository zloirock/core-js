...
enum K { Field = "data", Spare = "spare" }
interface Obj { data: string[]; other: string; }
declare const obj: Obj;
function noShadow() { return obj[K.Field].at(0); }
function constShadow() { const K = { Field: "other" } as const; return obj[K.Field].includes("x"); }
function paramShadow(K: { Field: "other"; }) { return obj[K.Field].at(0); }
