...
class Basic extends Array {
  static m() { const from = _Array$from; return from; }
}
export const viaBasic = Basic.m();

class Renamed extends _Map {
  static m() { const g = _Map$groupBy; return g; }
}
export const viaRenamed = Renamed.m();

class WithRest extends Array {
  static m() { const of = _Array$of;
const { of: _unused2, ...rest } = this; return [of, rest]; }
}
...
class ParamDefault extends Array {
  static m({ from, custom } = { from: _Array$from, custom: this.custom }) { return [from, custom]; }
}
...
class Outer extends _Map {
  static o() {
    class Inner extends Array {
      static i() { const from = _Array$from; return from; }
    }
    return Inner.i();
  }
}
...
class ForInit extends Array {
  static m() {
    for (let from = _Array$from, i = 0; i < 1; i++) { return [from, i]; }
  }
}
...
class KeyDefault extends Array {
  static m() { const from = _Array$from === void 0 ? 1 : _Array$from; return from; }
}
...
class AssignSeKey extends Array {
  static m() { ({ [(counted++, 'of')]: seTarget = _Array$of } = this); return seTarget; }
}
...
class Nullish extends Array {
  static m({ of } = this ?? _globalThis.Array) { return of; }
}
...
class SeKeyDecl extends Array {
  static m() { const o = _Array$of;
const { [(ticks++, 'of')]: _unused } = this; return o; }
}
export const viaSeKeyDecl = SeKeyDecl.m();

let beats = 0;
class SeKeyParam extends Array {
  static m({ [(beats++, 'from')]: f } = { "from": _Array$from }) { return f; }
}
...
class ArrowIife extends Array {
  static m() { return (({ of: viaArrow } = { of: _Array$of }) => viaArrow)(); }
}
export const viaArrowIife = ArrowIife.m();

const ClassExpr = class extends Array {
  static m() { const ce = _Array$from; return ce; }
};
export const viaClassExpr = ClassExpr.m();

const ns = { Promise: _Promise };
class MemberHeritage extends ns.Promise {
  static m() { const t = _Promise$try; return t; }
}
...
class StaticBlock extends Array {
  static { const of = _Array$of; this.picked = of; }
}
