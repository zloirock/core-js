...
let e = 0;
export const bodyExtract = (function f({ [_Symbol$iterator]: it } = Array) {
  let from = _Array$from;
  return [from([1]), it];
})();
export const restSibling = (({ from = _Array$from, ...rest } = Array) => [from, rest])();
export const seKeyDefault = (({ [(e++, 'from')]: from = [_Promise] } = { "from": _Array$from }) => from)();
export const keptDefault = (({ at = [_Promise] } = { at: _atMaybeArray([]) }) => at)();