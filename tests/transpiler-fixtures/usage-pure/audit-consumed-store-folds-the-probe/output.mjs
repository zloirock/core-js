...
export const guarded = null == (held = (e++, _self).window) ? void 0 : _Map;
...
export const callRootGuarded = null == (held = (e++, _self).window) ? void 0 : _Map;
...
export const seKeyedHopCallRoot = null == (held = (eff('d'), _self).window) ? void 0 : _Map;
