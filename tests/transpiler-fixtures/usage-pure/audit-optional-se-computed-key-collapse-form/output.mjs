...
export const viaIdentKey = null == (_ref = arr[eff(), 'foo']) ? void 0 : _atMaybeArray(_ref2 = _flatMaybeArray(_ref3 = _ref.call(arr)).call(_ref3)).call(_ref2, 0);
...
export const viaOddKey = null == (_ref4 = box[eff(), 'a-b']) ? void 0 : _findLastMaybeArray(_ref5 = _flatMaybeArray(_ref6 = _ref4.call(box)).call(_ref6)).call(_ref5, v => v > 0);
