...
export const r = null == (_ref = (() => _globalThis)()) ? void 0 : _joinMaybeArray(_ref2 = _flatMaybeArray(_ref.Array.prototype).call([1, [2]])).call(_ref2, ',');
// the deeper multi-hop tail (`.self.window`) drops both proxy hops the same way
export const d = null == (_ref3 = (() => _globalThis)()) ? void 0 : _joinMaybeArray(_ref4 = _flatMapMaybeArray(_ref3.Array.prototype).call([1], n => [n])).call(_ref4, ';');