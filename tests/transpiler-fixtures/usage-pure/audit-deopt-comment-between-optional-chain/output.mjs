...
const a = arr /* hint */ == null ? void 0 : _flatMaybeArray(arr).call(arr);
const b = obj /* hint */ == null ? void 0 : _at(obj)?.call(obj, 0) /* call */;
const c = list /* note */ == null ? void 0 : _includes(list)?.call(list, 1) /* call */;
const d = map?. /* k */get('k');