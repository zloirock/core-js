...
const tagged = (function tag(x = [1, 2]) { return x.at(0); })`str`;
const hopped = (function hop(x = [1, 2]) { return x.at(0); }).call(null, "hello");
const passed = (fn => fn("hello"))(function given(x = [1, 2]) { return x.at(0); });
const held = { run: function stored(x = [1, 2]) { return x.at(0); } }.run("hello");
function named(y = [1, 2]) { return y.includes(1); }
const pinned = named();
