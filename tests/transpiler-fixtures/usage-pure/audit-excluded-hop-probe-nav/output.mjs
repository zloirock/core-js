...
export const claim = null == (_ref4 = _globalThis.window) ? void 0 : _atMaybeArray(_ref5 = _Array$of(1)).call(_ref5, 0);
export const key = null == (_ref6 = _globalThis.window) ? void 0 : (_ref7 = _ref6.excludeBox.list, k++, _at(_ref7).call(_ref7, 0));
