...
export const intrinsicTagNotRef = (function div({ values, ...rest } = Object) {
...
export const selfRefInParamDefault = (function P({ all, ...rest } = Promise, cb = () => <P x={1} />) {
  return [all, rest, cb];
})();

// NEGATIVE: an intrinsic-spelled tag in a param default references nothing.
export const intrinsicInParamDefault = (function span({ race, ...rest } = Promise, cb = () => <span x={1} />) {
  return [race, rest, cb];
})();
