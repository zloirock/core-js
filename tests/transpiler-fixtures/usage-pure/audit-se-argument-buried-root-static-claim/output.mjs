...
let seCount = 0;
export const seArgStatic = null == (_ref = (x => _globalThis)(_Array$from([1]))?.window) ? void 0 : _atMaybeArray(_ref2 = _Array$of(5)).call(_ref2, 0);
export const seArgInstance = null == (_ref3 = (x => _globalThis)(_flatMaybeArray(_ref4 = [1, [2]]).call(_ref4))?.window) ? void 0 : _includesMaybeArray(_ref5 = _Object$values({
  b: 2
})).call(_ref5, 2);
export const seArgSequence = null == (_ref6 = (x => _globalThis)((seCount++, _padStartMaybeString(_ref7 = 'ab').call(_ref7, 3, '-')))?.window) ? void 0 : _endsWithMaybeString(_ref8 = _String$fromCodePoint(99, 100)).call(_ref8, 'd');
...
export const seBodyAndArg = null == (_ref9 = (x => {
  seCount++;
  return _globalThis;
})(_Object$entries({
  a: 1
}))?.window) ? void 0 : _flatMapMaybeArray(_ref10 = _Reflect$ownKeys({
  c: 3
})).call(_ref10, key => [key]);
