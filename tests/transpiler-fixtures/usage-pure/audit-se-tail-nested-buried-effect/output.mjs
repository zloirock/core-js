...
let c = 0;
let d = 0;
export const flattened = _flatMaybeArray((a++, b++, _self).Array.prototype).call([1, [2]], 1);
export const mapped = _flatMapMaybeArray((c++, d++, _self).Array.prototype).call([1, 2], n => [n]);