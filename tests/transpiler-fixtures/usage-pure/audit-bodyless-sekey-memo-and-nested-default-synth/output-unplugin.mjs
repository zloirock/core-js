...
export const a2 = (() => {
	if (cond) {
		var _ref2 = null || Array.prototype;
...
export const a3 = (() => {
	...
	do {
		var _ref3 = (_pushMaybeArray(log).call(log, 't'), Array.prototype);
...
export const b1 = (() => {
	function f({ at } = { at: _atMaybeArray(Array.prototype) }) {
		return at;
	}
...
export const b2 = (() => {
	function f({ at, flat } = Array.prototype) {
		return [at, flat];
	}
...
export const c1 = (() => {
	const { inner: { at } = { at: _atMaybeArray([1, 2]) } } = {};

	return typeof at;
})();

export const c2 = (() => {
	const { inner: { from } = { from: _Array$from } } = {};
...
export const c4 = (() => {
	try {
		throw {};
	} catch({ inner: { from } = { from: _Array$from } }) {
		return typeof from;
	}
})();
