...
export const a1 = (() => { if (cond) { var _ref = 1 ? Array.prototype : [];
var m = _findLastMaybeArray(_ref);
var { [(_pushMaybeArray(log).call(log, 'k'), 'findLast')]: _unused, other } = _ref; } return [typeof m, typeof other]; })();
export const a2 = (() => { if (cond) { var _ref2 = null || Array.prototype;
var m = _flatMapMaybeArray(_ref2);
var { [(_pushMaybeArray(log).call(log, 'k'), 'flatMap')]: _unused2, other } = _ref2; } return [typeof m, typeof other]; })();
export const a3 = (() => { let i = 0; do { var _ref3 = (_pushMaybeArray(log).call(log, 't'), Array.prototype);
var m = _atMaybeArray(_ref3);
var { [(_pushMaybeArray(log).call(log, 'k'), 'at')]: _unused3, other } = _ref3; } while (i++ < 0); return [typeof m, typeof other]; })();
// ... and an EFFECTFUL init rides the same memo - one evaluation, where the source ran it
export const a4 = (() => { if (cond) { var _ref4 = (() => { _pushMaybeArray(log).call(log, 'call'); return Array.prototype; })();
var m = _flatMaybeArray(_ref4);
var { [(_pushMaybeArray(log).call(log, 'k'), 'flat')]: _unused4, other } = _ref4; } return [typeof m, typeof other]; })();
// negative: with no SE key and a quiet init the slot keeps its single statement, no memo
export const a5 = (() => { if (cond) var at = _atMaybeArray(Array.prototype); return typeof at; })();
// an instance synth slot may spell an OBSERVABLE receiver once - a sole-prop pattern does
export const b1 = (() => { function f({ at } = { at: _atMaybeArray(Array.prototype) }) { return at; } return typeof f(); })();
...
export const c1 = (() => { const { inner: { at } = { at: _atMaybeArray([1, 2]) } } = {}; return typeof at; })();
export const c2 = (() => { const { inner: { from } = { from: _Array$from } } = {}; return typeof from; })();
export const c3 = (() => { let at; ({ inner: { at } = { at: _atMaybeArray([1, 2]) } } = {}); return typeof at; })();
...
export const c4 = (() => { try { throw {}; } catch ({ inner: { from } = { from: _Array$from } }) { return typeof from; } })();
export const c5 = (() => { try { throw {}; } catch ({ inner: { at } = { at: _atMaybeArray([1, 2]) } }) { return typeof at; } })();
