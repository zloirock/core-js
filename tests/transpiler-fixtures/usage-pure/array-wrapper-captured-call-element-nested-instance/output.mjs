...
const [_ref] = [realm()];
const soleAt = _atMaybeArray(_globalThis.Array.prototype);
let out;
for (const [_ref2, _ref3] = [realm(), eff('t')], headAt = _atMaybeArray(_globalThis.Array.prototype), tail = _ref3; !out;) out = [headAt, tail];
