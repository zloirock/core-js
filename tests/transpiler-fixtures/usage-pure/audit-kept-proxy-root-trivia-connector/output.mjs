...
let a;
export const viaBlockComment = (a = _globalThis.window)?.['Array'].from([3]);
// a dotted leaf behind trivia moves its own dot onto the connector - `? .` split by trivia does not parse
let b;
export const viaDottedGap = (b = _globalThis.window)?.Array.of(4);
let c;
export const viaLineComment = (c = _globalThis.window)?.['Object'].entries('q');