...
let x;
export const numericLeaf = (x = _globalThis, _self)[0];
let y;
export const symbolIterator = _getIteratorMethod((y = _globalThis, _self));
let z;
let k;
export const dynamicKey = (z = _globalThis, _self)[k];
// SE-bearing computed key stays in place after the collapsed receiver
let w;
let e = 0;
export const seKey = (w = _globalThis, _self)[e++, 0];
// deeper hop run collapses the same way
let v;
export const deepHop = (v = _globalThis, _self)[0];
...
let oa;
export const optionalRoot = (oa = _globalThis, _self)[0];
let ob;
export const optionalLeaf = (ob = _globalThis, _self)[0];
// SE-bearing HOP key folds into the collapse sequence at its native slot
let oc;
let g = 0;
export const seHopKey = (oc = _globalThis, g++, _self)[0];
...
let wa;
const box = {};
box[(wa = _globalThis, _self)[0] ?? 'k'] = 1;
export const writeKeyHost = box;
let sa;
export const spreadHost = Math.max(...((sa = _globalThis, _self)[0] ?? [0]));
let va;
...
let pa;
export const parenBetween = (pa = _globalThis, _self)[0];