...
function relabelLiteral(crate1) {
  return crate1;
}
const crate1 = {
  lend() {
...
export const viaLiteralMethodParam = (crate1.lend(), _Math$cbrt)(8);
function elsewhereLiteral() {
  const crate2 = 1;
  return crate2;
}
const crate2 = {
...
export const viaLiteralMethodLocal = (crate2.lend(), _Object$fromEntries)([]);