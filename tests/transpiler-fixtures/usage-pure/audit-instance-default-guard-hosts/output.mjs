...
let out1;
for (const {
    [(e1(), 'findLastIndex')]: _unused
  } = recvE, fli = (_ref4 = _findLastIndexMaybeArray(recvE)) === void 0 ? dfltE() : _ref4, {
    [(e2(), 'toSorted')]: _unused2
  } = recvE, tso = _toSortedMaybeArray(recvE); !out1;) out1 = [fli, tso];

// export host: the split keeps every binding exported
export const {
    [(e3(), 'toReversed')]: _unused3
  } = recvF,
  trv = (_ref5 = _toReversedMaybeArray(recvF)) === void 0 ? dfltF() : _ref5,
  {
    [(e4(), 'flatMap')]: _unused4
  } = recvF,
...
if (cnd) var {
  ...
  w5 = (_ref6 = _withMaybeArray(recvG)) === void 0 ? dfltG() : _ref6,
  {
    [(e6(), 'toSpliced')]: _unused6
  } = recvG,
  tsp = _toSplicedMaybeArray(recvG);
