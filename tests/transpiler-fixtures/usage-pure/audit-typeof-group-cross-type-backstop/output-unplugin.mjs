...
function fromObjectGroup(x: any) { if (typeof x === "object") return _at(x).call(x, 0); }
function fromNonString(y: any) { if (typeof y !== "string") return _includes(y).call(y, 1); }
function fromStringNarrow(w: any) { if (typeof w === "string") return _atMaybeString(w).call(w, 0); }
function fromConcreteArray(z: number[]) { return _flatMaybeArray(z).call(z); }
