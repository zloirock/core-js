...
// LHS (here a side-effect-free sequence prefix) must be marked skipped, else a stranded
// `globalThis -> _globalThis` rewrite fires with no target in the replacement (babel drops the
