...
_globalThis.tsBox = { n: 4, inner: { n: 5 }, list: ['ab', 'cd'] };
...
export const doubleCastDispatch = null == (_ref2 = (null == _globalThis.window ? void 0 : _self.tsBox as any).list) ? void 0 : _atMaybeArray(_ref2).call(_ref2, 0);

// a cast around the TAIL instead of the nav leaves the nav span whole, so the render applies
export const castOnTail = null == (_ref3 = (null == _globalThis.window ? void 0 : _self.tsBox.list)) ? void 0 : _atMaybeArray(_ref3).call(_ref3, 0);
...
let held: unknown;
export const castSealedCallee = ((null == _globalThis.window ? void 0 : _self) as any)(1);
