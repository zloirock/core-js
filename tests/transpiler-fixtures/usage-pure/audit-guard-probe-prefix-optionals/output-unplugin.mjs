...
export function pulledNewCallee() { return new (null == oc2().window ? void 0 : _self.chrome.Ctor)(4); }
...
export function assignThroughGuard() { (null == aw().window ? void 0 : _self).slotHost.n = 10; }
...
_globalThis.parenHost = { fn(x) { return x; }, Ctor: _Map };
