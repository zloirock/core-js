...
export const bareRootTwoHops = null == _globalThis.window?.window
	? void 0
	: _atMaybeArray(_ref = _Array$of(1)).call(_ref, 0);

export const optionalRootTwoHops = null == _globalThis.window?.window
	? void 0
	: _atMaybeArray(_ref2 = _Array$of(2)).call(_ref2, 0);

const dr = () => _globalThis;

export const provenRootTwoHops = null == dr()?.window?.window
	? void 0
	: _atMaybeArray(_ref3 = _Array$of(3)).call(_ref3, 0);
...
export const provenRootOneHop = null == sr()?.window
	? void 0
	: _atMaybeArray(_ref4 = _Array$of(4)).call(_ref4, 0);
...
export const chainAssignInstance = null == (held = _globalThis)?.window
	? void 0
	: _atMaybeArray(_ref5 = _Array$of(5)).call(_ref5, 0);

let heldDeep;

export const chainAssignInstanceTwoHops = null == (heldDeep = _globalThis)?.window?.window
	? void 0
	: _atMaybeArray(_ref6 = _Array$of(6)).call(_ref6, 0);

let heldPlainHop;

export const chainAssignPlainHop = null == (heldPlainHop = _globalThis).window?.window
	? void 0
	: _atMaybeArray(_ref7 = _Array$of(7)).call(_ref7, 0);
...
export const conditionalCalleeKeepsGuards = null == maybeFn?.()?.window
	? void 0
	: _atMaybeArray(_ref9 = _Array$of(10)).call(_ref9, 0);
...
export const optionalCallLinkKeepsGuard = null == provenFn?.()?.window
	? void 0
	: _atMaybeArray(_ref10 = _Array$of(11)).call(_ref10, 0);
...
export const opaqueRootKeepsGuard = null == (_ref11 = opaque()?.window?.self)
	? void 0
	: _at(_ref12 = _ref11.Array.of(12)).call(_ref12, 0);
...
export const unplannedOptionalTail = null == (_ref13 = null == ut().window ? void 0 : _self.chrome)
	? void 0
	: _at(_ref14 = _ref13.Array.of(13)).call(_ref14, 0);
...
class ConsumerHost {
	...
	inst = null == (_ref15 = cs()?.window)
		? void 0
		: _at(_ref16 = _ref15.consumerHost.list).call(_ref16, 0);
}
