...
export const combinedNoTail = null == (_ref5 = t = _globalThis.window) ? void 0 : _flatMaybeArray(_ref4 = _Array$of(2))?.call(_ref4);
...
let w;
export const nestedCombined = null == (_ref8 = null == (w = _globalThis.window) ? void 0 : _mapMaybeArray(_ref7 = _flatMaybeArray(_ref10 = _Array$of(5))?.call(_ref10))) ? void 0 : _at(_ref9 = _ref8.call(_ref7, x => x))?.call(_ref9, 0);
...
let a;
let b;
export const nestedKeptArg = null == (_ref12 = a = _globalThis.window) ? void 0 : _flatMaybeArray(_ref11 = _Array$of(null == (_ref13 = b = _globalThis.window) ? void 0 : _nameMaybeFunction(_Set)))?.call(_ref11);