...
let a;
let b;
export const nestedKeptArg = null == (_ref12 = a = _globalThis.window) ? void 0 : _flatMaybeArray(_ref13 = _Array$of(null == (_ref14 = b = _globalThis.window) ? void 0 : _nameMaybeFunction(_Set)))?.call(_ref13);