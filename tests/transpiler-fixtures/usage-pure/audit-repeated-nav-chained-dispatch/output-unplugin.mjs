...
_globalThis.chainBox = { n: 4, list: ['ab', 'cd'] };
...
export const deepChain = null == (_ref6 = null == (_ref7 = (_globalThis.window?.self.chainBox.list, _globalThis.window?.self.chainBox.list)) ? void 0 : _at(_ref7).call(_ref7, 0)) ? void 0 : _includes(_ref8 = _sliceMaybeArray(_ref9 = _sliceMaybeArray(_ref10 = _sliceMaybeArray(_ref6).call(_ref6, 1)).call(_ref10, 1)).call(_ref9, 1)).call(_ref8, 'a');
