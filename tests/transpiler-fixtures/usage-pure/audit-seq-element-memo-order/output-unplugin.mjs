...
q1 = (
	...
	(
		_ref = eff(),
		viaLeading = _atMaybeArray(_ref),
		{ length: viaLeadingLen } = _ref
	),
	5
);
...
q3 = (
	...
	(
		_ref2 = eff(),
		viaTwoLeads = _atMaybeArray(_ref2),
		{ length: viaTwoLeadsLen } = _ref2
	),
	5
);
...
q4 = (
	(
		_ref3 = eff(),
		viaNoLead = _atMaybeArray(_ref3),
		{ length: viaNoLeadLen } = _ref3
	),
	5
);
