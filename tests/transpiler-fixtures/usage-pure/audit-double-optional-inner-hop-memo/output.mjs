...
export const plainNav = null == _globalThis.window ? void 0 : _flatMaybeArray(_self.Array.prototype).call([2, [3]]);
// a DEAD first `?.` (over the pristine root) is not the live probe, so the split takes the second
export const deadFirstHop = null == (_ref = _globalThis.window) ? void 0 : _flatMaybeArray(_ref.Array.prototype).call([4]);
// an unknown binding keeps its source chain in the memo and re-reads `.self` off it
export const openBinding = null == (_ref2 = w?.self) ? void 0 : _flatMaybeArray(_ref2.self.Array.prototype).call([5]);
// a kept WRITE has a spelling that must run once: the memo holds the write, the hops fold
export const keptWrite = null == (_ref3 = p = _globalThis.window) ? void 0 : _flatMaybeArray(_ref3.Array.prototype).call([6]);
// ... and so does an effect-bearing sequence around it
export const seqAroundWrite = null == (_ref4 = (sc++, cb = _globalThis.window)) ? void 0 : _flatMaybeArray(_ref4.Array.prototype).call([7]);
export { w, p, cb, sc };