...
// fresh suffix. the flush census sees the user's own references, so the dead-import
// filter preserves the import even if the plugin never references it directly
