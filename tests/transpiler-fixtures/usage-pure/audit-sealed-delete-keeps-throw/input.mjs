...
let w1, w2;
export const sealedOverStore = delete ((w1 = globalThis.window)?.self?.window).customSlot;
export const openOverStore = delete (w2 = globalThis.window)?.self?.window.customSlot;
