...
// `typeof obj.inner.data` with 3+ qualified-name segments. findTypeQueryFunctionType
// walks the root binding's annotation segment-by-segment via findTypeMember (arbitrary
