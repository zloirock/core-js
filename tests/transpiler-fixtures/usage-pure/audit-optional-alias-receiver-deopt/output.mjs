...
// same pass had just substituted under it. the negatives keep it: a reassigned alias resolves to the
// ONE value its read observes (`Object`, whose `from` no polyfill backs - the read stays raw), and
// a local object is no global at all
const A = Array;
...
let R = Array;
R = Object;
export const reassigned = null == (_ref3 = R.from) ? void 0 : _at(_ref4 = _ref3.call(R, [3])).call(_ref4, -1);
const local = {
  from: xs => xs
};
