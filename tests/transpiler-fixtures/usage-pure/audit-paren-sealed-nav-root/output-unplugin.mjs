...
export function viaSealedSynthDefault({ getPrototypeOf: sp1 } = ((null == _globalThis.window ? void 0 : _self.window).Object, { getPrototypeOf: _Object$getPrototypeOf })) { return sp1; }
let c4 = 0;
export function viaSealedSeKeySynthDefault({ setPrototypeOf: sp2 } = (null == _globalThis.window ? void 0 : (c4++, _self)).Object) { return sp2; }
export { c4 };
...
export function viaSealedSynthResidualBail({ groupBy: sn1, customK: sn2 } = ((null == _globalThis.window ? void 0 : _self.window).Object, { groupBy: _Object$groupBy, customK: (null == _globalThis.window ? void 0 : _self.window).Object.customK })) { return [sn1, sn2]; }
...
let c5 = 0;
export function viaSealedLogicalSynth({ fromEntries: sl1 } = ((null == _globalThis.window ? void 0 : (c5++, _self)).Object, { fromEntries: _Object$fromEntries })) { return sl1; }
let cond1 = true;
export function viaSealedBranchSynth({ assign: sb1 } = cond1 ? ((null == _globalThis.window ? void 0 : _self.window).Object, { assign: _Object$assign }) : { assign: _Object$assign }) { return sb1; }
export { c5 };
...
class SealedHost {
  field = (({ is: fv } = ((null == _globalThis.window ? void 0 : (c6++, _self)).Object, { is: _Object$is })) => fv)();
}
...
let c7 = 0;
export function viaSealedSeKeyResidualBail({ getOwnPropertyNames: nb1, customK: nb2 } = (function (_ref6) { return { getOwnPropertyNames: _Object$getOwnPropertyNames, customK: _ref6.customK }; })((null == _globalThis.window ? void 0 : (c7++, _self)).Object)) { return [nb1, nb2]; }
export function viaSealedLogicalRawBail({ seal: nb3 } = ((null == _globalThis.window ? void 0 : _self.window).Object, { seal: _Object$seal })) { return nb3; }
...
export const { [(c8++, 'defineProperty')]: _unused } = (null == _globalThis.window ? void 0 : _self.window).Object;
export { c8 };
...
let cc1 = 0, kc1 = 0;
const dheCombo = () => { cc1++; return _globalThis; };
