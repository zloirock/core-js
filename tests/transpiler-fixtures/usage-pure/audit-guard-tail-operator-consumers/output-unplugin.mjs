...
export const neqRight = 1 !== (null == _globalThis.window ? void 0 : _Object$assign({}, { a: 1 }).a);
...
export const leRight = 1 <= (null == _globalThis.window ? void 0 : _Reflect$ownKeys({ a: 1 }).length);
...
const arrowBody = () => null == _globalThis.window ? void 0 : _Object$entries({ a: 1 }).length;
function returned() {
  var _ref3, _ref4;
...
let switched = 0;
switch (1) {
  case 1: switched = null == _globalThis.window ? void 0 : _Math$hypot(3, 4); break;
  default: break;
}
export { switched };