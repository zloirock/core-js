...
_globalThis.siblingBox = { list: ['ab', 'cd'] };
...
export const handWrittenGuardSecond = null == (_ref8 = (null == _globalThis.window ? void 0 : _self.siblingBox.list,
  null == _globalThis.window ? void 0 : _globalThis.siblingBox.list)) ? void 0 : _at(_ref8).call(_ref8, 0);
