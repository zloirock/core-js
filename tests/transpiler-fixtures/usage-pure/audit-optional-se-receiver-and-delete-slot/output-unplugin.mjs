...
export const b1 = (() => { if (cond) var m = _flatMaybeArray(arr); return typeof m; })();
export const b2 = (() => { let i = 0; do var m = _flatMaybeArray(arr); while (i++ < 0); return typeof m; })();
// ... while a STATIC leaf under the same hop never needed that receiver - its own pure is the value
export const b3 = (() => { if (cond) var o = _Array$of; return typeof o; })();
...
export const c1 = (() => { delete _globalThis[_Symbol$iterator]; return 1; })();
export const c2 = (() => { delete (arr[_Symbol$iterator]); return 1; })();
