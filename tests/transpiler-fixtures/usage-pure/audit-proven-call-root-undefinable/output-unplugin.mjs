...
let n = 0, w;
_globalThis.callRootBox = { list: [[1]] };
...
export const probeCallDispatch = null == (_ref = provenProbe()) ? void 0 : _flatMaybeArray(_ref2 = _ref.callRootBox.list).call(_ref2);
...
let held;
export const writeStoresRoot = null == (_ref3 = null == (held = (n++, _globalThis)).window ? void 0 : _self.callRootBox.list) ? void 0 : _flatMaybeArray(_ref3).call(_ref3);
export { n, w, held };