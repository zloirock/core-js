...
const fnArg = (function ({ Promise }) { return Promise; })({ Promise: _Promise });
const assign = _Object$assign;
const arrowArg = (({ Map }) => Map)({ Map: _Map });
const allSettled = _Promise$allSettled;
const secondArg = (function (a, { Set }) { return Set; })(1, { Set: _Set });
const keys = _Object$keys;
const optionalArg = (function ({ Set }) { return Set; })?.({ Set: _Set });
const freeze = _Object$freeze;
const constructedArg = new (function ({ Map }) { this.m = Map; })({ Map: _Map });
const isInteger = _Number$isInteger;
const nested = () => { const NAME = 'Promise'; return _Promise; };
...
const plainArg = (function (g) { return g; })(_globalThis);
