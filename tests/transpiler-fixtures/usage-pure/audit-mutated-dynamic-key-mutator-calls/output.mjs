...
_Object$defineProperties(_Map, descriptors);
export const multiDefined = _Map.groupBy([1], x => x);
_Object$assign(_Iterator, source, {
  [key]: 1
});
export const assigned = _Iterator.range(0, 3);
_Reflect$set(_Promise, key, 1);
export const reflected = _Promise.try(() => 1);
...
_Object$defineProperty(_URL, key, {
  value: 1
});
export const optionalDefined = _URL.parse('https://a.io');
