...
let c = 0,
  d = 0;
export const folded = (d++, c++, _globalThis)?.foo;
export const deepRun = (d++, c++, _globalThis)?.bar;
export const tailRead = (d++, c++, _globalThis)?.baz.qux;
export const aliasRoot = (d++, c++, g)?.quux;
export const foldedCall = (d++, c++, _globalThis)?.garply();
export const aliasCall = (d++, c++, g)?.waldo();
export const probeUnder = (d++, c++, _globalThis)?.corge;
export const probeOverBacked = (d++, c++, _globalThis)?.grault;
...
export const flatTwin = (d++, _globalThis).foo;
