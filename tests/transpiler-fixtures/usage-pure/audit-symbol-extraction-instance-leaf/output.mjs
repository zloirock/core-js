...
const _ref2 = Array;
const of = _Array$of;
const viaSiblingCtor = _nameMaybeFunction(_getIteratorMethod(_ref2)); // NEGATIVE: a DEFAULTED leaf keeps the destructure - binding the dispatcher result directly would
