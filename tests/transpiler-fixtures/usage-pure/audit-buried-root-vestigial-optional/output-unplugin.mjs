...
export const deadOptionalArg = null == (_ref3 = ((x) => _self)(1)?.window) ? void 0 : _includesMaybeArray(_ref4 = _Object$values({ a: 1 })).call(_ref4, 1);
export const deadOptionalDeep = null == (_ref5 = (() => _self)()?.window) ? void 0 : _flatMaybeArray(_ref6 = _Reflect$ownKeys({ b: 2 })).call(_ref6);
