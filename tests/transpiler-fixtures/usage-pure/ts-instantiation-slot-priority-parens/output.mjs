...
const viaNestedInstantiation = _Array$of<any>(1);
const viaSatisfies = _Array$from<any>([1]);
export const r = [viaBigInt, viaBoolean, viaNull, viaRegExp, viaTemplate, viaImport, viaMetaProperty, viaNestedInstantiation, viaSatisfies, viaArrow, viaConditional, viaAssign, viaBinary, viaLogical, viaUnary, viaPostfix, viaPrefix, viaOptionalMember, viaOptionalCall, viaOptionalStatic, viaCast, viaAssertion, viaBare, viaMember, viaNonNull, viaSequence];