...
let n;
export const nonMutatedSingle = null == (n = _globalThis.window) ? void 0 : _nameMaybeFunction(_WeakSet);
// the ALIAS spelling hides the undefinable navigation behind the binding - same guard
const w = _globalThis.window;
let a;
export const aliasMutated = null == (_ref2 = a = w) ? void 0 : _nameMaybeFunction(_ref2.Set);
let b;
export const aliasNonMutated = null == (b = w) ? void 0 : _nameMaybeFunction(_WeakSet);
...
let dp;
export const doubleParenRoot = null == (_ref3 = dp = _globalThis.window) ? void 0 : _nameMaybeFunction(_ref3.Set);
