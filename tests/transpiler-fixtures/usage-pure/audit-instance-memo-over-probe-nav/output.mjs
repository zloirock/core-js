...
export const memoOverProbe = null == (_ref = null == _globalThis.window ? void 0 : _self.Array) ? void 0 : _flatMaybeArray(_ref.prototype);
export const memoOverProbeCall = null == (_ref2 = null == _globalThis.window ? void 0 : _self.Array) ? void 0 : _flatMaybeArray(_ref2.prototype).call([[1]]);
export const memoTwoKeys = null == (_ref3 = null == _globalThis.window ? void 0 : _self.Array) ? void 0 : _includesMaybeArray(_ref3.prototype);
// the same nav with no instance tail keeps the plain guarded read
export const plainRead = (null == _globalThis.window ? void 0 : _self.Array)?.prototype;
...
export const sealedKeys = null == (_ref4 = (null == _globalThis.window ? void 0 : _self.Array).prototype) ? void 0 : _flatMaybeArray(_ref4);
// NEGATIVE: no probe under the `?.` - the nav collapses whole and no guard is built
export const noProbe = null == (_ref5 = _globalThis.Array) ? void 0 : _flatMaybeArray(_ref5.prototype);