...
export const memoOverProbe = null == (_ref = _globalThis.Array) ? void 0 : _flatMaybeArray(_ref.prototype);
export const memoOverProbeCall = null == (_ref2 = _globalThis.Array) ? void 0 : _flatMaybeArray(_ref2.prototype).call([[1]]);
export const memoTwoKeys = null == (_ref3 = _globalThis.Array) ? void 0 : _includesMaybeArray(_ref3.prototype);
// the same nav with no instance tail keeps the plain guarded read
export const plainRead = _globalThis.Array?.prototype;
...
export const sealedKeys = null == (_ref4 = _globalThis.Array.prototype) ? void 0 : _flatMaybeArray(_ref4);
