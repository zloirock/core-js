...
export const escaping = { of: () => other };
const key = [0].pop();
function relabel(box1) { return box1; }
function box1(value) { return [value]; }
export const viaParam = box1(Array)[key].from([1]);
function relabelDefault(box2 = 1) { return box2; }
function box2(value) { return [value]; }
export const viaDefaultedParam = box2(Object)[key].entries({});
function relabelPattern({ box3 }) { return box3; }
function box3(value) { return [value]; }
export const viaPatternParam = box3(Array)[key].of(1);
const relabelArrow = box4 => box4;
function box4(value) { return [value]; }
export const viaArrowParam = box4(String)[key].raw`x`;
const relabelling = { relabel(box5) { return box5; } };
function box5(value) { return [value]; }
export const viaMethodParam = box5(String)[key].fromCodePoint(65);
function elsewhere() { const box6 = 1; return box6; }
function box6(value) { return [value]; }
