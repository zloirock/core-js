...
let k2;
export const aliasOfPonyfilled = (k2 = aliasSelf)?.Object.entries({ a: 1 });
...
let k4;
export const aliasThroughCall = (k4 = aliasFactory())?.Reflect.ownKeys({ b: 2 });
...
const { self: extracted } = globalThis;
export const destructuredHop = extracted.Array.from([1, 2]);
const { window: extractedWindow } = globalThis;
export const destructuredUnponyfilled = extractedWindow?.Object.values({ c: 3 });
const { self: { window: extractedNested } } = globalThis;
export const destructuredNested = extractedNested?.Object.fromEntries([['d', 4]]);
const [{ self: fromArray }] = [globalThis];
export const destructuredThroughArray = fromArray.Promise.resolve(1);
const { self: withDefault = globalThis } = globalThis;
...
export const nonNullOnUnponyfilled = (k9 = globalThis.window!)?.Object.keys({ e: 5 });
let k10;
export const satisfiesOnPlainHop = (k10 = (globalThis.self satisfies object))?.Object.assign({}, { f: 6 });
