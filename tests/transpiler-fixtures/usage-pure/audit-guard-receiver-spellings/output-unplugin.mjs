...
export const aliasOfPonyfilled = (k2 = aliasSelf, _Object$entries)({ a: 1 });
...
export const aliasThroughCall = (k4 = aliasFactory(), _Reflect$ownKeys)({ b: 2 });
...
export const aliasOfMidHopNav = null == (k6 = aliasNested) ? void 0 : _Array$of(5);
