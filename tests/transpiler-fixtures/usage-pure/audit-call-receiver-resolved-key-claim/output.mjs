...
export const claimInsideArgument = null == _globalThis.window ? void 0 : null == (_ref10 = _globalThis.window) ? void 0 : _Array$of(_Math$trunc(1.5));
export const parenthesizedClaim = _Array$of(1);
export const claimThenInstance = null == (_ref11 = _globalThis.window) ? void 0 : _atMaybeArray(_ref12 = _Array$from('ab')).call(_ref12, 0);
