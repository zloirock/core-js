...
let e = 0;
let c = 0;
export const belowLeaf = null == (u = _globalThis.window) ? void 0 : _toFixedMaybeNumber(_ref = (g++, _Number$MAX_SAFE_INTEGER)).call(_ref, 2);
export const atLeaf = null == (u = _globalThis.window) ? void 0 : _toFixedMaybeNumber(_ref2 = (g++, _Number$MAX_SAFE_INTEGER)).call(_ref2, 2);
