...
export const attribute = null == (_ref9 = null == (w = _globalThis.window) ? void 0 : _flatMaybeArray(_ref10 = _Array$of(<a title="it's">x</a>))?.call(_ref10)) || null == (_ref11 = _mapMaybeArray(_ref9)) ? void 0 : _at(_ref12 = _ref11.call(_ref9, x => x))?.call(_ref12, 0);