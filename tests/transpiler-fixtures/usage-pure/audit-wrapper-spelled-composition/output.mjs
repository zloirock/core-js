...
export const wrapperSpelledRoot = null == (_ref = _globalThis.window) ? void 0 : _atMaybeArray(_ref2 = _Array$of(2)).call(_ref2, 0);
...
export const composedAtStatementStart = null == (_ref3 = (null == (_ref4 = _flatMaybeArray(_ref5 = getArr())?.call(_ref5)) ? void 0 : _flatMapMaybeArray(_ref4)).call(_ref4, x => x)) ? void 0 : _atMaybeArray(_ref3).call(_ref3, 0);

// the wrapper around the root of a plain (non-optional) navigation composes the same way
export const wrapperSpelledPlainRoot = _atMaybeArray(_ref6 = _Array$of(3, 4)).call(_ref6, -1);