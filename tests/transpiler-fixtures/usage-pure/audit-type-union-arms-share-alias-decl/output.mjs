...
export function armsShareOneAliasDecl() {
  var _ref;
  return _atMaybeArray(_ref = _atMaybeArray(shared).call(shared, 0)).call(_ref, 0);
}

// the control: one declaration per arm, so nothing can be re-entered either way
export function armsUseDistinctAliasDecls() {
  var _ref2;
  return _includesMaybeArray(_ref2 = _atMaybeArray(distinct).call(distinct, 0)).call(_ref2, "x");
}