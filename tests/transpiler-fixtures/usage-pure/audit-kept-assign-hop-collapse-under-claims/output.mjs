...
let k;
export const instanceCall = _atMaybeArray(_ref = (k = _self).Array.prototype).call(_ref, 0);
export const instanceGet = _atMaybeArray((k = _self).Array.prototype);
export const vestigialOptional = _atMaybeArray(_ref2 = (k = _self).Array.prototype).call(_ref2, 0);
export const name = _nameMaybeFunction(_atMaybeArray(_ref3 = (k = _self).Array.prototype).call(_ref3, 0));

// the spelling both emitters already agreed on - the static claim reads the same collapsed value
export const staticClaim = (k = _self, _Array$of);
