...
export const iifeCallTail = null == (() => _globalThis)() ? void 0 : _atMaybeArray(_ref8 = _Array$from([1])).call(_ref8, 0);
export const iifeTriple = null == (_ref9 = (() => _globalThis)()) ? void 0 : _at(_ref10 = _nameMaybeFunction(_includesMaybeArray(_ref9.Array.prototype))).call(_ref10, 0);
...
export const midHopOptional = null == (_ref11 = _globalThis.baz) ? void 0 : _includes(_ref12 = _nameMaybeFunction(_ref11)).call(_ref12, 'z');
// controls: a plain-object receiver and an inner instance-CALL keep their existing shapes
export const objControl = obj == null ? void 0 : _at(_ref13 = _nameMaybeFunction(obj.foo)).call(_ref13, 0);
export const innerCallControl = _includes(_ref14 = _at(_ref15 = _globalThis.foo).call(_ref15, 0)).call(_ref14, 'a');