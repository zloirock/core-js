...
export const prefixInstance = _nameMaybeFunction((q = (_atMaybeArray(arr).call(arr, 0), _self).window, _Map));
...
export const bareUnresolvableTail = _nameMaybeFunction((q = _self.window, _Map));
let w;
export const nestedWriteTail = _nameMaybeFunction((q = w = _self.window, _Map));
...
export const tailStaticRead = (q = _self.window, _Number$MAX_SAFE_INTEGER);
export const tailStaticCall = (q = (_Promise$resolve(2), _self).window, _Array$of)(7);
export const tailFallback = (q = _self.window, _Promise).noSuchStatic;
