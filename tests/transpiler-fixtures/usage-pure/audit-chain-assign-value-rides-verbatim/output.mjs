...
export const prefixInstance = _nameMaybeFunction((q = (_atMaybeArray(arr).call(arr, 0), _globalThis).self.window, _Map));
...
export const parenValueWithPrefix = _nameMaybeFunction((q = (_atMaybeArray(arr).call(arr, 0), _self)).Map);
