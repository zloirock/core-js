...
const { Array: { from }, [_Symbol$iterator]: _unused } = obj;
...
const fb = { done: true };
const { done } = (_ref2 = _getIteratorMethod(obj)) === void 0 ? fb : _ref2;
...
const { [_Symbol$iterator]: _unused2 } = arr;
...
const { [(c++, 'of')]: _unused3, [_Symbol$iterator]: _unused4 } = Array;
...
const _ref3 = [7];
const { length: litArity, call: litCall } = _getIteratorMethod(_ref3);
const { [_Symbol$iterator]: _unused5 } = _ref3;
const _ref4 = holder.p;
const { length: memArity } = _getIteratorMethod(_ref4);
const { [_Symbol$iterator]: _unused6, sib } = _ref4;
const _ref5 = cond ? [8] : [];
const { length: brArity } = _getIteratorMethod(_ref5);
const { [_Symbol$iterator]: _unused7, alt } = _ref5;
const _ref6 = mk();
const { length: callArity } = _getIteratorMethod(_ref6);
const { [_Symbol$iterator]: _unused8, q } = _ref6;
...
const _ref7 = holder2.p;
const ts = _toSortedMaybeArray(_ref7);
const { length: mixArity } = _getIteratorMethod(_ref7);
const { [(k2(), 'toSorted')]: _unused9, [_Symbol$iterator]: _unused10 } = _ref7;
// EXPORT host: the memo plants as a bare statement before the export (never exported itself)
const _ref8 = holder3.p;
export const { length: expArity } = _getIteratorMethod(_ref8);
export const { [_Symbol$iterator]: _unused11, expQ } = _ref8;
