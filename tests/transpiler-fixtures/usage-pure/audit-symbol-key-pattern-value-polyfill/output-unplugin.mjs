...
const { [(c++, 'of')]: _unused2, [_Symbol$iterator]: _unused3 } = Array;
...
const { length: litArity, call: litCall } = _getIteratorMethod([7]);
...
const { [(k2(), 'toSorted')]: _unused7, [_Symbol$iterator]: _unused8 } = _ref6;
...
export const { [_Symbol$iterator]: _unused9, expQ } = _ref7;
