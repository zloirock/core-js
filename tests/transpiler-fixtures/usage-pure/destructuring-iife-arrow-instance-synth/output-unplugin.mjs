...
export const viaInlineSpreadArg = (({ at: atSpread }) => atSpread)(...[{ at: _atMaybeArray([1, 2]) }]);
export const viaInlineSpreadStringArg = (({ at: atSpreadStr }) => atSpreadStr)(...[{ at: _atMaybeString("abc") }]);
export const viaInlineSpreadSecondSlot = ((first, { entries: entriesSpread }) => entriesSpread)(...[other, { entries: _entriesMaybeArray([1, 2]) }]);
...
export const viaComputedKeyFolds = (({ ["at"]: aKey }) => aKey)({ ["at"]: _atMaybeArray([1, 2]) });
