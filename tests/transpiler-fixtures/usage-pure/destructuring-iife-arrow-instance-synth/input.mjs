...
export const viaCallArgRunsOnce = (({ findLast }) => findLast)(mk());
...
export const viaDefaultedProp = (({ copyWithin = null }) => copyWithin)([1, 2]);
...
export const viaNestedIifes = (({ fill }) => (({ concat }) => concat)([1, [2]]))([3, 4]);
