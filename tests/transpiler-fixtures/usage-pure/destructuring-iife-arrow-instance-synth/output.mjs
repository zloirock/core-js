...
export const viaMixedProps = (({
  flatMap,
  other
}) => [flatMap, other])({
  flatMap: _flatMapMaybeArray([1, 2]),
  other: [1, 2].other
});
export const viaAliasedProp = (({
  findLastIndex: fli
}) => fli)({
...
export const viaOptionalCall = (({
  ...
  keys: _keysMaybeArray([1, 2])
});
export const viaDotCallStaysNative = (({
  values
}) => values).call(null, [1, 2]);
...
export const viaCommaHost = (0, ({
  toReversed
}) => toReversed)({
  toReversed: _toReversedMaybeArray([1, 2])
});
export const viaFnExprValue = function ({
  findIndex
}) {
  return findIndex;
}({
...
export const viaMultiArgPairing = ((first, {
  entries
}) => entries)(other, {
  entries: _entriesMaybeArray([1, 2])
});
export const viaRestSiblingBails = (({
  flat,
  ...rest
}) => [flat, rest])([1, [2]]);

// the receiver typing follows the argument's family; nested IIFEs register independently
export const viaStringArg = (({
  at: atStr
}) => atStr)({
  at: _atMaybeString("abc")
});
export const viaNumberArg = (({
  toFixed
}) => toFixed)({
...
export const viaInlineSpreadArg = (({
  at: atSpread
}) => atSpread)(...[{
  at: _atMaybeArray([1, 2])
}]);
export const viaInlineSpreadStringArg = (({
  at: atSpreadStr
}) => atSpreadStr)(...[{
  at: _atMaybeString("abc")
}]);
export const viaInlineSpreadSecondSlot = ((first, {
  entries: entriesSpread
}) => entriesSpread)(...[other, {
  entries: _entriesMaybeArray([1, 2])
}]);
export const viaNonLiteralSpreadBails = (({
  flat: flatSpread
}) => flatSpread)(...mkArgs());
