...
export const seqAssign = null == (c++, n = gw) ? void 0 : _nameMaybeFunction(_Map.prototype.has);
export const chainAssign = null == (a = gw) ? void 0 : _nameMaybeFunction(_Set.prototype.add);
