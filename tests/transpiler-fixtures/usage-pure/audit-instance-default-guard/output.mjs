...
const {
  ...
  f = (_ref2 = _flatMaybeArray(recvB)) === void 0 ? dfltB() : _ref2,
  other = 1;
...
const {
  ...
  i = (_ref4 = _includesMaybeArray(_ref3)) === void 0 ? dfltC() : _ref4;

// eliminate arm (array-wrapped sole binding, pure key): no residual survives, the guard
// wraps the extraction in place
const toReversed = (_ref5 = _toReversedMaybeArray(recvD)) === void 0 ? dfltD() : _ref5; // native evaluates a destructure PER PROP (key, read, default, next key): the residual
...
const {
  ...
  fl = (_ref6 = _findLastMaybeArray(recvE)) === void 0 ? dfltE() : _ref6,
  {
    [(e5(), 'findLastIndex')]: _unused5
  } = recvE,
  fli = _findLastIndexMaybeArray(recvE);
...
const _ref8 = [9],
  ...
  w7 = (_ref9 = _withMaybeArray(_ref8)) === void 0 ? dfltG() : _ref9,
  {
    [(e8(), 'toSpliced')]: _unused8
  } = _ref8,
  t8 = _toSplicedMaybeArray(_ref8);
