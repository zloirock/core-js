...
let s;
let k = 0;
export const doubleHopName = null == (n = _globalThis.window) ? void 0 : _nameMaybeFunction(_Set);
export const doubleHopCallTail = null == (t = _globalThis.window) ? void 0 : _at(_ref = _nameMaybeFunction(_Map)).call(_ref, 0);
export const doubleHopOptCall = null == (c = _globalThis.window) ? void 0 : _at(_ref2 = _nameMaybeFunction(_WeakMap))?.call(_ref2, 0);
...
export const doubleHopKeySe = null == (s = _globalThis.window) ? void 0 : (k++, _nameMaybeFunction(_Set));
