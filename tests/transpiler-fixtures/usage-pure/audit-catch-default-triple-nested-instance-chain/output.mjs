...
try {} catch (_ref) {
  ...
  let it = (_ref2 = _getIteratorMethod(_ref)) === void 0 ? _atMaybeArray(_ref3 = _flatMaybeArray(_ref4 = _flatMaybeArray(_ref5 = [9]).call(_ref5)).call(_ref4)).call(_ref3, 0) : _ref2;
  it;
}