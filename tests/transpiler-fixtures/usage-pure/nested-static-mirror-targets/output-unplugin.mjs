...
({
	...
	Object: {
		keys: {
			[(
				_pushMaybeArray(events).call(events, _atMaybeString(_ref = 'x').call(_ref, 0)),
				'bind'
			)]: bind
		}
	}
...
({
	...
	Object: {
		keys: box[(
			_pushMaybeArray(events).call(events, _atMaybeString(_ref2 = 'y').call(_ref2, 0)),
			'value'
		)]
	}
} = {
...
({
	...
	Object: {
		keys: box[(
			_pushMaybeArray(events).call(events, _atMaybeString(_ref3 = 'z').call(_ref3, 0)),
			'value'
		)] = (defaults++, null)
	}
} = {
...
function read(
	{
		...
		Object: {
			keys: {
				[(
					_pushMaybeArray(events).call(events, _atMaybeString(_ref8 = 'b').call(_ref8, 0)),
					'bind'
				)]: bound
			}
		}
