...
for (const { [(f3++, 'keys')]: _unused2 } = (null == _globalThis.window ? void 0 : _self).Object,
	viaForInitSeKey = _Object$keys; f3 < 2; ) {
...
export const viaFlatBareNav = (
	(null == _globalThis.window ? void 0 : _self).structuredClone,
	_structuredClone
);

export const viaArrayWrapped = (
	(null == _globalThis.window ? void 0 : _self).Math,
	_Math$hypot
);
...
export const viaCallRootIife = (
	(null == ((x) => x)(_globalThis).window ? void 0 : _self).Object,
	_Object$values
);
...
export const viaCtorLeafRenamed = (
	(null == _globalThis.window ? void 0 : Array).from,
	_Array$from
);
...
export const viaCtorLeafSealed = (
...
export const viaConsumedFirstA = (
	(null == _globalThis.window ? void 0 : _self).Array,
	_Array$of
);
...
export const viaStringKeyFirst = (
	(null == _globalThis.window ? void 0 : _self).Array,
	_Array$of
);
...
export const viaSymbolFirst = (
	(null == _globalThis.window ? void 0 : _self)[_Symbol$iterator],
	_getIteratorMethod(_self)
);
...
export const viaBareProbe = (
	(null == _globalThis.window ? void 0 : _globalThis.window).Array,
	_Array$of
);

export const viaBareProbeSealed = (
	(null == _globalThis.window ? void 0 : _globalThis.window).Array,
	_Array$of
);

export const viaBareProbeFlat = (
	(null == _globalThis.window ? void 0 : _globalThis.window).structuredClone,
	_structuredClone
);

export const viaBareProbeTernary = (
	(null == _globalThis.window ? void 0 : _globalThis.window).Array,
	_Array$of
);
