...
export const unsealedTwin = null == (_ref5 = _flatMaybeArray(_ref6 = getArr())) || null == (_ref7 = _ref5.call(_ref6))
	? void 0
	: _flatMapMaybeArray(_ref7).call(_ref7, (x) => x);

export const sealedInnerCall = null == (_ref8 = _flatMaybeArray(_ref9 = getArr())?.call(_ref9))
	? void 0
	: _flatMapMaybeArray(_ref8).call(_ref8, (x) => x);