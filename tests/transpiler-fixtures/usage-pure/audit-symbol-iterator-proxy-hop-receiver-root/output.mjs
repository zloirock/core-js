...
const single = _getIteratorMethod(_self);
const deep = _getIteratorMethod(_globalThis);
const optional = _getIteratorMethod(_self);
const getCall = [..._getIterator(_self)];
const parenWrapped = _getIteratorMethod(_self);
