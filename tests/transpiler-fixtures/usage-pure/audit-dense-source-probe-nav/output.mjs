...
export const claim = null == _globalThis.window ? void 0 : _atMaybeArray(_ref6 = _Array$of(1)).call(_ref6, 0);
export const chain = null == (_ref7 = null == (_ref8 = null == _globalThis.window ? void 0 : _self.denseBox.list) ? void 0 : _at(_ref8).call(_ref8, 0)) ? void 0 : _sliceMaybeArray(_ref7).call(_ref7, 0).length;
let a = [1];
a;
_forEach(_ref9 = (null == _globalThis.window ? void 0 : _self.denseBox.list) ?? []).call(_ref9, function () {});
export { k, a };