...
export const probeLeafRead = _self.WeakRef;
export const probeLeafClaim = _Symbol$iterator;
export const probeLeafTail = _self.Array?.prototype;
// NEGATIVE: no `?.` at all - the whole navigation collapses, probe included (the multihop canon)
export const plainDeepNav = _self.customKey;
...
export const firstHopProbe = _self.BigInt;