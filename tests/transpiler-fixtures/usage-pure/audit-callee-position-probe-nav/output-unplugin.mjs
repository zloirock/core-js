...
let heldDot;
export const dotCall = null == (heldDot = _globalThis).window ? void 0 : _self.calleeBox.fn.call(_globalThis.calleeBox);
...
export const plainAssignDispatch = null == (_ref5 = (heldPlainDispatch = _globalThis).window) ? void 0 : _at(_ref6 = _ref5.unknownCalleeBox.list).call(_ref6, 0);
