...
function read({ Array: { from }, Set } = { Array: { from: _Array$from }, Set: _globalThis.Set }) { return [from([1]), new Set()]; }
...
const { [k()]: v } = (_globalThis.Set === undefined ? _Set : _globalThis.Set);
export const sk = v;
