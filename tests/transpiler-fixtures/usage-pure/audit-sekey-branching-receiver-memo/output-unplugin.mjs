...
var a1 = _atMaybeArray(_ref);
var { [(k1++, 'at')]: _unused, other1 } = _ref;
...
const arr3 = [2];
var _ref3 = arr3 ?? [];
var inc3 = _includesMaybeArray(_ref3);
var { [(k3++, 'includes')]: _unused3, other3 } = _ref3;
...
const arr4 = [3], arr5 = [4];
var _ref4 = arr4 && arr5;
var fl4 = _findLastMaybeArray(_ref4);
var { [(k4++, 'findLast')]: _unused4, other4 } = _ref4;
...
function pick(c) {
	...
	var fm = _flatMapMaybeArray(_ref5);
	var { [(k5++, 'flatMap')]: _unused5, other5 } = _ref5;
...
const { y: { [(k6++, 'values')]: _unused6 }, z6 } = { y: _ref6, z6: 1 };
...
for (var _ref8 = 1 ? [6] : [],
	{ [(k8++, 'entries')]: _unused8, other8 } = _ref8,
	e8 = _entriesMaybeArray(_ref8),
	i8 = 0; i8 < 1; i8++) out8 = typeof e8;
...
var _ref9 = mk9();
var a9 = _atMaybeArray(_ref9);
var { [(k9++, 'at')]: _unused9, other9 } = _ref9;
...
var f10 = _flatMaybeArray(_ref10);
var { [(k10++, 'flat')]: _unused10, other10 } = _ref10;
...
var inc11 = _includesMaybeArray(_ref11);
var { [(k11++, 'includes')]: _unused11, other11 } = _ref11;
...
var fl12 = _findLastMaybeArray(_ref12);
var { [(g12++, 'findLast')]: _unused12, other12 } = _ref12;
...
var _ref13 = mk13();
var a13 = _atMaybeArray(_ref13);
var { [(k13++, 'at')]: _unused13, ...rest13 } = _ref13;
...
var f14 = _flatMaybeArray(_ref14);
var { [(k14++, 'flat')]: _unused14, other14 } = _ref14;
...
export var { [(k17++, 'toSorted')]: _unused17, other17 } = _ref17;
...
export var { [(k18++, 'values')]: _unused18, other18 } = _ref18,
	_u18 = _values(_ref18),
	z18 = 1;
...
export var z19 = 1,
	_ref19 = holder19.p,
	{ [(k19++, 'keys')]: _unused19, other19 } = _ref19,
	_u19 = _keys(_ref19);
