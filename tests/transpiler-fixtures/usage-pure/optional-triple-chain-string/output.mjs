...
(_ref = (_ref3 = str == null ? void 0 : _trimStartMaybeString(str).call(str)) == null ? void 0 : _trimEndMaybeString(_ref3).call(_ref3)) == null ? void 0 : _padStartMaybeString(_ref).call(_ref, 2);