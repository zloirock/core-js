...
null == (_ref = null == (_ref2 = str == null ? void 0 : _trimStartMaybeString(str).call(str)) ? void 0 : _trimEndMaybeString(_ref2).call(_ref2)) ? void 0 : _padStartMaybeString(_ref).call(_ref, 2);