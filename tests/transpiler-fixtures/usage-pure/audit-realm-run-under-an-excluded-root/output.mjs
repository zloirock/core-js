...
export const guardedTail = _self.window?.customProp;
export const guardedHop = _self.window.customProp;
export const guardedBoth = _self.window?.customProp;
export const guardedOverStore = (q = globalThis, _self).window?.customProp;
