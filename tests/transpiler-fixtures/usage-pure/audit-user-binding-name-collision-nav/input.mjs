...
globalThis.collideBox = { list: ['ab', 'cd'] };
const _globalThis = { window: { self: { collideBox: { list: [9] } } } };
const _globalThis2 = { window: { self: { collideBox: { list: [8] } } } };
const _self = { collideBox: { list: [7] } };
