...
export const hopInsideIdentityArg = null == (_ref3 = (x => x)(_self)?.window) ? void 0 : _flatMaybeArray(_ref4 = _Object$entries({ a: 1 })).call(_ref4);
export const deepHopInsideBuriedRoot = null == (_ref5 = (() => _self)()?.window) ? void 0 : _includesMaybeArray(_ref6 = _Object$values({ b: 2 })).call(_ref6, 2);
export const unponyfillableHopStaysRooted = null == (_ref7 = (() => _globalThis.window)()) ? void 0 : _flatMapMaybeArray(_ref8 = _Reflect$ownKeys({ c: 3 })).call(_ref8, k => [k]);
