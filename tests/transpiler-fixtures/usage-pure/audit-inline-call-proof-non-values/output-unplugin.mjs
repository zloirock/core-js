...
export const generator = (function* () { return Array; })().from([1]);
export const asyncGenerator = (async function* () { return Object; })().entries({ a: 1 });
export const bareReturn = (() => { return; })().hypot(3, 4);
export const noReturn = (function () { })().parseFloat('1.5');
export const thisValue = (function () { return this; })().ownKeys({ b: 2 });
