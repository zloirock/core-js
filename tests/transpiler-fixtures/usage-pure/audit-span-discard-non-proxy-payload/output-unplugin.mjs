...
export const { noSuchStatic } = _globalThis.Number;
...
export const consumedInit = (() => { const of = _Array$of; return typeof of; })();
...
export const prefixGlobal = _nameMaybeFunction((_globalThis, _Map));
export const prefixNav = _nameMaybeFunction((_self, _Map));
export const prefixDiscard = _nameMaybeFunction((0, _Map));
