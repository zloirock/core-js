...
export function viaSymbolVarShadow() {
  { const symVarRoot = {}; var symHeld = symVarRoot; }
  { const { asyncIterator } = symHeld; return [1][asyncIterator]; }
}
...
const nsRoot = Object;
const nsLink = nsRoot;
namespace SideNs { export const unrelated = 1; }
export function viaNamespaceSibling(nsRoot) {
  const { fromEntries } = nsLink;
  return fromEntries([]);
}
