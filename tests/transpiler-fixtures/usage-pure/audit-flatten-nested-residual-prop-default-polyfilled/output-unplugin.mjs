...
const { withAt = _atMaybeArray(_ref = [1]).call(_ref, 0) } = _globalThis.Array;
const resolve = _Promise$resolve;
const { withAny = _Promise$any([2]) } = _Promise;
const fromEntries = _Object$fromEntries;
const { twoA = _atMaybeArray(_ref2 = [3]).call(_ref2, 0), twoB = _flatMaybeArray(_ref3 = [4]).call(_ref3) } = _globalThis.Object;
