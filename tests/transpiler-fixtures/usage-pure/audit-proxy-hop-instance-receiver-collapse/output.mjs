...
const sliced = _sliceMaybeArray(_self.Array.prototype).call([1, 2, 3], 1);
const found = _self.Array.prototype.indexOf.call([1, 2, 3], 2);
const flat = _flatMaybeArray(_self.Array.prototype).call([[1]]);
