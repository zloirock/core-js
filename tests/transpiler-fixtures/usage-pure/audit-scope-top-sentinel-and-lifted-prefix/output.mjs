...
for (const _ref4 = ({
    fromAsync: _unused,
    ...rP
  } = _globalThis.Array, aP = _Array$fromAsync, Object), isSealed = _Object$isSealed; !oP;) oP = isSealed;
const recvA = getObj();
...
for (const _ref5 = ({
    allSettled: _unused2,
    ...rQ
  } = _Promise, aQ = _Promise$allSettled, Object), isFrozen = _Object$isFrozen; !oQ;) oQ = isFrozen;
// the same pair inside a FUNCTION: push order, no family grouping
export function inFn() {
  var _ref2, _unused3, _ref3;
  const recvB = getObj();
  ...
  for (const _ref6 = ({
      groupBy: _unused3,
      ...rR
    } = _Map, aR = _Map$groupBy, Object), getPrototypeOf = _Object$getPrototypeOf; !oR;) oR = getPrototypeOf;
  const recvC = getObj();
