...
const arr = [1, 2];
null == (_ref = _flatMaybeArray(arr)) ? void 0 : _filterMaybeArray(_ref2 = _sliceMaybeArray(_ref3 = _mapMaybeArray(_ref4 = _ref.call(arr)).call(_ref4, x => x * 2)).call(_ref3, 1))?.call(_ref2, y => y > 4);