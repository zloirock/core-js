...
// DOUBLE-paren-wrapped assignment as the root of an optional proxy chain. the reprint spells
...
export const doubleMapHas = null == (n = gw) ? void 0 : _nameMaybeFunction(_Map.prototype.has);
export const doubleSetAdd = null == (s = gw) ? void 0 : _nameMaybeFunction(_Set.prototype.add);
export const singleWeakGet = null == (w = gw) ? void 0 : _nameMaybeFunction(_WeakMap.prototype.get);