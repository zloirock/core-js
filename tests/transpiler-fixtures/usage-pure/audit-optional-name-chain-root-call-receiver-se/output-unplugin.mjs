...
let n = 0;
const bareRoot = null == (_ref = (() => { n += 1; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_ref.self.Map);
const deepHop = null == (_ref2 = (() => { n += 10; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_ref2.self.window.Set);
const keySe = null == (_ref3 = (() => { n += 100; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_ref3.self[(n += 1000, "WeakMap")]);
