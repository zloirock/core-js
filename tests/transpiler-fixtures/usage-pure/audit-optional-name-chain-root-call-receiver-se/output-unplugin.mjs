...
let n = 0;
const bareRoot = null == (_ref = (() => { n += 1; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_Map);
const deepHop = null == (_ref2 = (() => { n += 10; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_Set);
const keySe = null == (_ref3 = (() => { n += 100; return _globalThis; })()) ? void 0 : _nameMaybeFunction((n += 1000, _WeakMap));
const keySeTail = null == (_ref4 = (() => { n += 10000; return _globalThis; })()) ? void 0 : _nameMaybeFunction(_ref4[(n += 1e5, "Set")].prototype.add);
