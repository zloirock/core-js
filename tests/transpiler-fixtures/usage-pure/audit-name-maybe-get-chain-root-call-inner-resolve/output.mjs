...
// The call is harvested + re-emitted as a prefix, and its inner content must be resolved EXACTLY
// as the natural visitor would (the receiver collapse leaves the call's body visitor-rewritten,
// and the prefix must carry those rewrites) - NOT a hand-rolled identifier-only re-emit. Two inner
