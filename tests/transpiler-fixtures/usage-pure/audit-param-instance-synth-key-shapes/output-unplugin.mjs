...
const identifierKey = (function ({ at } = { at: _atMaybeArray([1, 2]) }) {
  return at;
})();
const stringKey = (function ({ 'flat': f } = { "flat": _flatMaybeArray([1, 2]) }) {
  return f;
})();
const foldedComputedKey = (function ({ ['flat' + 'Map']: fm } = { ['flat' + 'Map']: _flatMapMaybeArray([1, 2]) }) {
  return fm;
})();
const templateKey = (function ({ [`findLa${ 'st' }`]: fl } = { [`findLa${ 'st' }`]: _findLastMaybeArray([1, 2]) }) {
  return fl;
})();
...
let effects = 0;
const sideEffectingKey = (function ({ [(effects++, 'findIndex')]: fi } = { "findIndex": _findIndexMaybeArray([1, 2]) }) {
  return fi;
})();
...
const dynamicKeyStaysNative = (function ({ [_globalThis.pick]: p } = [1, 2]) {
  return p;
})();
