...
for (var { isArray: ia3 } = _globalThis.Array,
	_ref3 = Array.prototype,
	{ [(k3++, 'includes')]: _unused3, o3 } = _ref3,
...
if (1) {
	var { keys: ks5 } = _globalThis.Array;
	const _ref5 = Array.prototype;

	var { [(k5++, 'at')]: _unused5, [(j5++, 'flat')]: _unused6, other5 } = _ref5,
