...
function viaCall(a = [1, 2]) { return a.at(0); }
function viaApply(b = [1, 2]) { return b.keys(); }
function viaBind(c = [1, 2]) { return c.values(); }
function viaReflect(d = [1, 2]) { return d.entries(); }
function overridden(e = [1, 2]) { return e.includes('a'); }
function opaqueApply(f = [1, 2]) { return f.find(x => x); }
const spread = ['ab'];
export default [
  viaCall.call(null),
  viaApply.apply(null, []),
  viaBind.bind(null)(),
  Reflect.apply(viaReflect, null, []),
  overridden.call(null, 'ab'),
  opaqueApply.apply(null, spread),
];
