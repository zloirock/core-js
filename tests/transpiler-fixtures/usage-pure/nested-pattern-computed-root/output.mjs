...
const viaCall = _at(mk().data);
const viaNew = _at(new Box().data);
const viaMember = _at(holder.inner.data);
const viaSlotDefault = _at((_ref = mk().data) === void 0 ? fallback : _ref);
const viaLeafDefault = (_ref2 = _at(mk().data)) === void 0 ? null : _ref2;
const besideSibling = _at(mk().data);
const tail = 1;
export const exported = _at(mk().data);
