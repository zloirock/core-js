...
for (const _ref = (_globalThis.effect ??= 1, _globalThis),
	_ref2 = _ref.Array.prototype,
	headValues = _valuesMaybeArray(_ref2),
	headAt = _atMaybeArray(_ref2),
	headKeys = _Object$keys; !out1; ) out1 = [headValues, headAt, headKeys];
