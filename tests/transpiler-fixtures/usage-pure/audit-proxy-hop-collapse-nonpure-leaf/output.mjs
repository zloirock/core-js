...
const aliasKey = "self";
const named = new _self.Array(3);
const computedAlias = new _self.Array(3);
const multiHop = new _self.Array(3);
const staticOffHop = _self.Array.isArray([1]);
const {
  defaulted = _self.Array
} = {};
