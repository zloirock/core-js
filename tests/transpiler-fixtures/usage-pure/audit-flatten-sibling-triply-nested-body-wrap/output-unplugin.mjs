...
const sibling = () => { var _ref; return _atMaybeArray(_ref = [1]).call(_ref, 0) + ((() => { var _ref2; return _atMaybeArray(_ref2 = [2]).call(_ref2, 0) + ((() => { var _ref3; return _atMaybeArray(_ref3 = [3]).call(_ref3, 0); })()); })()); };
