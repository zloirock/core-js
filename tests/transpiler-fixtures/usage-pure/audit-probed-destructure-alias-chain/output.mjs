...
export const viaAliasChainNested = ((null == heldProbe ? void 0 : heldProbe).Array, _Array$of); // In a full consume with several properties, one extraction carries the throw probe.
// The emitters may choose different properties within the partial-assignment-on-throw boundary.
export const viaAliasChainMultiA = _Array$of;
export const viaAliasChainMultiB = (heldProbe.Array, _Array$from);
export const {
  of: viaAliasChainRestA,
  ...viaAliasChainRest
} = heldProbe.Array;