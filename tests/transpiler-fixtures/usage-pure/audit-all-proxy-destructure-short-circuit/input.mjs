...
export const { zzz: viaSealed } = (globalThis.window?.self).window;
export const { zzz: viaOptional } = globalThis.window?.self.window;
export const [viaArrayPattern] = (globalThis.window?.self).window;
...
export const { zzz: viaPlainDeepNav } = globalThis.self.window;
