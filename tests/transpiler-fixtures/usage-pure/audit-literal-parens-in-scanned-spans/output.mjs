...
export const argParen = null == (_ref = (() => _globalThis)()?.window) ? void 0 : _atMaybeArray(_ref2 = _Array$of(')')).call(_ref2, 0);
export const keyParen = null == (_ref3 = _globalThis.window) ? void 0 : _flatMaybeArray(_ref4 = _Object$entries({
  ')': 1
})).call(_ref4);
export const tailParen = _padEndMaybeString(_ref5 = _String$fromCodePoint(40)).call(_ref5, 4, ')');
export const bothParens = null == (_ref6 = _globalThis.window) ? void 0 : _toFixedMaybeNumber(_ref7 = _Number$parseFloat('1.5(')).call(_ref7, 1);
export const nestedQuote = _includesMaybeString(_ref8 = _JSON$stringify({
  a: '")'
})).call(_ref8, 'a');
