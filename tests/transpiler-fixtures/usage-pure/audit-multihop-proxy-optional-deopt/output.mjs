...
// triple hop.
const winLeaf = _flatMaybeArray(_self.Array.prototype).call([1, [2]]);
const selfLeaf = _includesMaybeArray(_self.Array.prototype).call([1], 1);
const deepHop = _atMaybeArray(_self.Array.prototype).call([3, 4], 0);
