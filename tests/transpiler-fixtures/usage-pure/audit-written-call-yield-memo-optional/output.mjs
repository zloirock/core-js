...
export const writtenCall = null == (held = ca())?.window ? void 0 : _atMaybeArray(_ref = _Array$of(1)).call(_ref, 0);
// inside a RENDERED drop the same written call reads plain: the prefix IS the test
export const renderedDrop = null == (heldRoot = ca2())?.window ? void 0 : _atMaybeArray(_ref2 = _Array$of(3)).call(_ref2, 0);
