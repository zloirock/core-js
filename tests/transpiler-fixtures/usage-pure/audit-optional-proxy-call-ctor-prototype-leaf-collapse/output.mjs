...
const rebindWrapperAbove = null == (() => _globalThis)() ? void 0 : _nameMaybeFunction(_Set.prototype.add);
const rebindSymbolIter = null == (() => _globalThis)() ? void 0 : _getIteratorMethod(_WeakMap.prototype);
