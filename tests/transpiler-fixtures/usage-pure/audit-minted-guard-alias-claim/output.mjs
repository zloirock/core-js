...
const heldGuardSelf = null == _globalThis.window ? void 0 : _self;
export const mintedGuardAliasClaim = String((heldGuardSelf.Array.of, _Array$of)(21));
export const mintedGuardAliasFallback = (heldGuardSelf.Promise, _Promise);