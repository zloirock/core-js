...
const effectSecond = function ({
  getOwnPropertyNames: g1,
  [(effects++, 'getOwnPropertyNames')]: g2
} = {
...
const duplicateSeKeys = function ({
  [(effects++, 'of')]: a,
  [(effects++, 'of')]: b
} = {
  "of": _Array$of
...
export { duplicateUnresolvedSlot, numericAndStringSpelling, duplicateResolvedSlot, foldedSpellingOfSameSlot, effectFirst, effectSecond, duplicateSeKeys, effects };