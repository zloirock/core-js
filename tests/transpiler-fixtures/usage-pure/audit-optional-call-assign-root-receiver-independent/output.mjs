...
let w, v;
const f = () => _globalThis;
export const arrowVal = _atMaybeArray(_ref = (w = f(), _Array$of)(5)).call(_ref, 0);
export const iifeVal = _includesMaybeArray(_ref2 = (v = (() => _globalThis)(), _Array$from)([1])).call(_ref2, 1);