...
type Arr = number[];
type Str = string;
function useArr(a: Arr) { return _atMaybeArray(a).call(a, 0); }
function useStr(s: Str) { return _atMaybeString(s).call(s, 0); }
function useArr2(b: Arr) { return _includesMaybeArray(b).call(b, 1); }
