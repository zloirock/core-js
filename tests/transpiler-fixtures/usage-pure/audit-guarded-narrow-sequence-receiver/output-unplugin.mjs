...
export const destructured = (() => { const g = M === _Map ? _Map$groupBy : M.groupBy; return g; })();
export const destructuredShorthand = (() => { const groupBy = M === _Map ? _Map$groupBy : M.groupBy; return groupBy; })();
export const destructuredSeq = (() => { const g = (n++, M === _Map ? _Map$groupBy : M.groupBy); return g; })();
