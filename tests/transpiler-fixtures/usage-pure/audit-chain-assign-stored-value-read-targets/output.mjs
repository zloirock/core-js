...
var _ref;
// a kept assignment whose claim the target matrix declines spells its VALUE for every user
// target - read, exported or unread alike: an alias read later classifies through the rendered
