...
// leaf is transiently unresolved when the flat key is visited; the shared mixed-pattern mirror gate
// defers BOTH emitters' body-extract / inline-default fallbacks so the synth default owns every key
