...
const { foo: f11 } = _ref10;
const { junk: j9 } = _globalThis.Array;
const _ref11 = _Array$of;
const viaProxyNav = _nameMaybeFunction(_ref11);
const { foo: f12 } = _ref11;

const _ref12 = box,
	_ref13 = _ref12.y,
	userFirst = _atMaybeArray(_ref13),
	{ other: o1 } = _ref13,
	{ junk: j10 } = _ref12;

const _ref14 = box, { junk: j11 } = _ref14;
const _ref15 = _ref14.y;
const userLast = _atMaybeArray(_ref15);
const { other: o2 } = _ref15;
const _ref16 = box, { junk: j12 } = _ref16;
const _ref18 = (_ref17 = _ref16.y) === void 0 ? [] : _ref17;
const userDefault = _atMaybeArray(_ref18);
const { other: o3 } = _ref18;

const _ref19 = box,
	{ junk: j13 } = _ref19,
	_ref20 = _ref19.y,
	userMiddle = _atMaybeArray(_ref20),
	{ other: o4 } = _ref20,
	{ more: m2 } = _ref19;
...
const { junk: j21 } = Array;
const soleBesideNavJunk = _nameMaybeFunction(_Array$of);
const { junk: j22 } = _globalThis.Array;
const soleBesideHostJunk = _nameMaybeFunction(_Array$of);
const { junk: j23 } = _globalThis;
const _ref21 = box;
const soleUserBesideJunk = _atMaybeArray(_ref21.y);
const { junk: j25 } = _ref21;
const { junk: j15 } = Array;
const _ref22 = _Array$of;
const viaLet = _nameMaybeFunction(_ref22);
const { foo: f13 } = _ref22;

const { of: { name: viaLeadingDeclarator, foo: f14 }, junk: j16 } = Array,
	z1 = 1;

const z2 = 1, { junk: j17 } = Array;
const _ref23 = _Array$of;
const viaTrailingDeclarator = _nameMaybeFunction(_ref23);
const { foo: f15 } = _ref23;

for (const { of: { name: viaForInit, foo: f16 }, junk: j18 } = Array; ; ) {
	[viaForInit, f16, j18];
...
export {
	...
	viaLet,
	f13,
	viaLeadingDeclarator,
	f14,
	j16,
	z1,
	z2,
	viaTrailingDeclarator,
	f15,
	j17,
	viaBodyless,
	f17,
