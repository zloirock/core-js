...
let p;
export const inDestructureDefault = (({ x = null == (_ref2 = p = _globalThis.window) ? void 0 : _includesMaybeArray(_ref2.Array.prototype) } = {}) => x)();
...
let sw;
switch ((sw = _globalThis.window)?.[c++, "Array"]) { default: break; }
...
export const fromSynthDefault = (({ from } = (_globalThis.window ?? { from: x => [x] })) => from)([1]);
...
let sy;
export const ofKeptDouble = (({ isArray } = {}) => isArray)((sy = _globalThis.window)?.[c2++, "Array"] ?? {});
export { c2 };