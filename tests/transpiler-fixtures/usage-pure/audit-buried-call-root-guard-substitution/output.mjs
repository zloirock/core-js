...
export const functionExprRoot = null == (_ref5 = function () {
  return _globalThis;
}()?.window) ? void 0 : _toFixedMaybeNumber(_ref6 = _Number$MAX_SAFE_INTEGER).call(_ref6, 2);
...
export const effectfulBodyRoot = null == (_ref9 = (() => {
  bodyCount++;
  return _globalThis;
})()?.window) ? void 0 : _findLastIndexMaybeArray(_ref10 = _Object$entries({
  a: 1
})).call(_ref10, pair => pair[0] === 'a');
let keyCount = 0;
export const computedKeyRoot = null == (_ref11 = (() => _globalThis)()?.window) ? void 0 : _includesMaybeArray(_ref12 = (keyCount++, _Object$values)({
  b: 2
})).call(_ref12, 2);

// BOUNDARY: the callee is declared above the chain, so its global sits outside the guard's span
const above = () => _globalThis;
export const declaredCallee = null == (_ref13 = above()?.window) ? void 0 : _flatMapMaybeArray(_ref14 = _Reflect$ownKeys({
  c: 3
})).call(_ref14, key => [key]);
...
const reads = x => x;
export const paramReadingRoot = reads({
  window: {
    Set: {
      prototype: null
    }
