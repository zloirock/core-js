...
let e = 0, f = 0, q, r, s, t;
const g = globalThis;
export const seqRoot = (e++, globalThis).self.Math;
export const seqInAssignRoot = (r = (e++, globalThis)).self.Intl;
export const aliasSeqInAssign = (s = (f++, g)).self.WeakRef;
export const deepInterleaved = (t = (q = (0, globalThis))).self.Math.max(1, 2);
export const parenRoot = (globalThis).self.JSON;
export const seqAssignRoot = (f++, q = globalThis).self.Date;
export const aliasSeqRoot = (e++, g).self.Number;
export const aliasParenRoot = (g).self.Atomics;
