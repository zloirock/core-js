...
export const r1 = _at(v).call(v, 0);
interface Loose {
  ys: string[];
  blah;
}
declare const w: Loose[keyof Loose];
export const r2 = _includes(w).call(w, "q");
interface Homo {
  as: number[];
  bs: boolean[];
}
declare const h: Homo[keyof Homo];
export const r3 = _atMaybeArray(h).call(h, 1);
interface WithGetter {
  get size(): string[];
  zs: string[];
}
declare const g2: WithGetter[keyof WithGetter];
export const r4 = _includesMaybeArray(g2).call(g2, "z");
...
export function viaParam<T extends LooseC>(o: T, k: keyof T) {
  var _ref;
  return _includes(_ref = o[k]).call(_ref, 3);
}