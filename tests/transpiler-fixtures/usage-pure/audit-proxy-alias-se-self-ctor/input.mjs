...
// `g.self.Map` -> `g.Map` and crashing the transform queue against the whole-constructor `_Map`
// rewrite. combines SE-prefix, alias-root, and `.self` hop cases into one receiver.
function effect() {
  return 0;
}
const g = globalThis;
