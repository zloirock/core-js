...
let ticks = 0;
export const readTwoEffectCarrier = (ticks++, ticks++, globalThis.window?.self)?.Promise[(ticks++, 'noSuchStatic')];
export const readOneEffectCarrier = (ticks++, globalThis.window?.self)?.Promise[(ticks++, 'noSuchStatic')];
export { ticks };
