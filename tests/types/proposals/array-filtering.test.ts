...
testFilterReject(new BigInt64Array([1n,2n]), 1n);
testFilterReject(new BigUint64Array([1n,2n]), 1n);
...
// @ts-expect-error
(new BigInt64Array([1n,2n,3n])).filterReject((x: number) => false);

// @ts-expect-error
(new BigUint64Array([1n,2n,3n])).filterReject((x: number) => false);