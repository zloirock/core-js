...
QUnit.test('mutated native constructors: direct writes keep callable identity', assert => {
  ...
  try {
    Object.fromEntries = () => 'object patch';
    String.raw = () => 'string patch';
    Array.from = () => ['array patch'];
