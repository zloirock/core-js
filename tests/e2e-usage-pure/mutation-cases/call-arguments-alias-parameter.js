...
QUnit.test('mutation call channel: call-arguments-alias-parameter', assert => {
  ...
  function install(x) {
    // eslint-disable-next-line prefer-rest-params -- The arguments alias is the channel under test.
    const a = arguments;
    a[0].from = patched;
  }
  try {
