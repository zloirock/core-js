...
(function(){
  ...
  test('Array::pluck', function(){
    ok(isFunction(Array.prototype.pluck), 'Array::pluck is function');
  ...
  test('Array::reduceTo', function(){
    var arr, obj;
    ok(isFunction(Array.prototype.reduceTo), 'Array::reduceTo is function');
  ...
  test('Array::merge', function(){
    var arr;
    ok(isFunction(Array.prototype.merge), 'Array::merge is function');
    arr = [1, 2, 3];
