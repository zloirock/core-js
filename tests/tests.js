...
(function(){
  ...
  test('call unbound log.#{..}', function(){
    ...
    for (i$ = 0, len$ = (ref$ = methods).length; i$ < len$; ++i$) {
      x$ = ref$[i$];
      ok((fn$()), "call unbound log." + x$);
    }
    function fn$(){
      try {
        log[x$].call(void 8, 'foo');
        return true;
      } catch (e$) {}
    }
  });
...
(function(){
  'use strict';
  var strict, descriptors, eq, deq, isFunction, toString$ = {}.toString;
  strict = function(){
    return this;
  }.call(void 8) === void 8;
...
(function(){
  ...
  test('RegExp#{sticky, unicode}', function(){
    ok('sticky' in RegExp.prototype);
    ok('unicode' in RegExp.prototype);
    eq(/./.sticky, false);
    eq(/./.unicode, false);
  });
}).call(this);
...
(function(){
  ...
  if (toString$.call(this.process).slice(8, -1) !== 'process') {
    ...
    methods = ['assert', 'count', 'debug', 'dir', 'dirxml', 'error', 'exception', 'group', 'groupEnd', 'groupCollapsed', 'groupEnd', 'info', 'log', 'table', 'trace', 'warn', 'markTimeline', 'profile', 'profileEnd', 'time', 'timeEnd', 'timeStamp'];
    test('console available', function(){
      ok(typeof console != 'undefined' && console !== null, 'global.console available');
    });
    test('console.{..} available', function(){
      var i$, x$, ref$, len$;
      for (i$ = 0, len$ = (ref$ = methods).length; i$ < len$; ++i$) {
        x$ = ref$[i$];
        ok(x$ in console, "console." + x$ + " available");
      }
    });
