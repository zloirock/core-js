...
(function(){
  'use strict';
  var module, test, global, MODERN, STRICT, Promise, Symbol, iterator;
  module = QUnit.module, test = QUnit.test;
  module('ES6');
  ...
  test('Promise', function(assert){
    ...
    new Promise(function(resolve, reject){
      ...
      assert.same(this, STRICT ? void 8 : global, 'correct executor context');
    });
  });
  if (MODERN) {
