...
(function(){
  QUnit.assert.isIterable = function(it, message){
    var ref$;
    this.push(typeof it[(typeof Symbol != 'undefined' && Symbol !== null ? Symbol.iterator : void 8) || (typeof core != 'undefined' && core !== null ? (ref$ = core.Symbol) != null ? ref$.iterator : void 8 : void 8)] === 'function', false, true, message || 'is iterable');
  };
}).call(this);
