...
(function(){
  ...
  test('*', function(){
    strictEqual(core.Number.MAX_SAFE_INTEGER, Math.pow(2, 53) - 1, 'Is 2^53 - 1');
  });
}).call(this);
...
(function(){
  ...
  test('*', function(){
    strictEqual(core.Number.MIN_SAFE_INTEGER, -Math.pow(2, 53) + 1, 'Is -2^53 + 1');
  });
}).call(this);
...
(function(){
  ...
  test('*', function(){
    ok(toString$.call(core.Number.parseFloat).slice(8, -1) === 'Function', 'Is function');
  });
}).call(this);
...
(function(){
  ...
  test('*', function(){
    ok(toString$.call(core.Number.parseInt).slice(8, -1) === 'Function', 'Is function');
  });
}).call(this);
