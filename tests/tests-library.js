...
// Generated by LiveScript 1.3.1
(function(){
  var isFunction, ref$, map, every, reduce, toString$ = {}.toString;
...
(function(){
  ...
  test('*', function(){
    ...
    if ('name' in from) {
      eq(from.name, 'from', 'name is "from"');
    }
    deq(from('123'), ['1', '2', '3']);
    deq(from({
      length: 3,
...
(function(){
  ...
  test('*', function(){
    ...
    if ('name' in core.Array.of) {
      eq(core.Array.of.name, 'of', 'name is "of"');
    }
...
(function(){
  ...
  test('*', function(){
    ok(core.Symbol.hasInstance in Function.prototype);
    ok(Function[core.Symbol.hasInstance](function(){}));
...
(function(){
  ...
  if ('__proto__' in Object.prototype) {
    test('Reflect.setPrototypeOf', function(){
      ...
      ok(core.Reflect.setPrototypeOf(o = {}, o) === false, 'false on recursive __proto__');
      ok(core.Reflect.setPrototypeOf(core.Object.freeze({}), {}) === false, 'false on frozen object');
    });
  }
  function in$(x, xs){
    var i = -1, l = xs.length >>> 0;
