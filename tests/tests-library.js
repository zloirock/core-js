...
(function(){
  ...
  test('Array#slice', function(){
    ...
    deq(slice(arr, 1, void 8), ['2', '3', '4', '5']);
    ...
    deq(slice(str, 1, void 8), ['2', '3', '4', '5']);
    ...
    if (list = typeof document != 'undefined' && document !== null ? (ref$ = document.body) != null ? ref$.childNodes : void 8 : void 8) {
      try {
        eq(toString$.call(slice(list)).slice(8, -1), 'Array');
      } catch (e$) {
        e = e$;
        ok(false);
      }
  ...
  test('Array#map', function(){
    ...
    deq([2, 3, 4], map([1, 2, 3], (function(it){
      return it + 1;
    })));
    deq([1, 3, 5], map([1, 2, 3], curry$(function(x$, y$){
      return x$ + y$;
    })));
    deq([2, 2, 2], map([1, 2, 3], function(){
      return +this;
    }, 2));
  });
  test('Array#filter', function(){
    ...
    deq([1, 2, 3, 4, 5], filter([1, 2, 3, 'q', {}, 4, true, 5], function(it){
      return toString$.call(it).slice(8, -1) === 'Number';
    }));
  });
...
// Generated by LiveScript 1.3.1
(function(){
  var Reflect, Object, Symbol, eq, deq, isFunction, MODERN, REAL_FREEZE, toString$ = {}.toString;
  QUnit.module('ES6 Reflect');
  Reflect = core.Reflect, Object = core.Object, Symbol = core.Symbol;
  eq = strictEqual;
  deq = deepEqual;
  isFunction = function(it){
    return toString$.call(it).slice(8, -1) === 'Function';
  ...
  test('Reflect', function(){
    ok(Reflect != null, 'Reflect is defined');
  });
  ...
  test('Reflect.construct', function(){
    ...
    ok((function(){
      try {
        return Object.getPrototypeOf(construct(f, [])) === Function('return this')().Object.prototype;
      } catch (e$) {
        e = e$;
        return false;
      }
  ...
  test('Reflect.enumerate', function(){
    ...
    deq(core.Array.from(enumerate(obj)).sort(), ['a', 'd', 'e', 'q', 's', 'w'], 'works with prototype');
    throws(function(){
      return enumerate(42);
    }, TypeError, 'throws on primitive');
  });
...
(function(){
  ...
  if ((typeof HTMLCollection != 'undefined' && HTMLCollection !== null) && ((typeof document != 'undefined' && document !== null) && document.getElementsByTagName) && toString$.call(document.getElementsByTagName('div')).slice(8, -1) === 'HTMLCollection') {
    test('HTMLCollection.prototype@@iterator', function(){
      ok(core.isIterable(document.getElementsByTagName('div')), 'Is iterable');
    });
  }
}).call(this);
