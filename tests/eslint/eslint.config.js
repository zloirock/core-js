...
const typeDefinitionsTests = {
  ...disable(forbidNonStandardBuiltIns),
};
...
export default [
  {
    ignores: [
      ...
      'tests/e2e-libs/@(.tmp|artifacts|report)/**',
  ...
  {
    files: [
      'packages/core-js-types/src/**/*.d.ts',
      'tests/type-definitions/**/*.ts',
    ],
    languageOptions: {
