...
const pr1: CoreJSPromiseAndPromiseLike<number> = promiseResolve(42);
declare const p1: Promise<number>;
const pf1: CoreJSPromiseAndPromiseLike<number> = promiseFinally(p1);
const pf2: CoreJSPromiseAndPromiseLike<number> = promiseFinally(p1, undefined);
const pf3: CoreJSPromiseAndPromiseLike<number> = promiseFinally(p1, null);
