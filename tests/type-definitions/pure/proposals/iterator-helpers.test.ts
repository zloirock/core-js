...
import { assertCoreJSIteratorLike } from '../../helpers/helpers.pure.js';
...
const findString: string | number | undefined = iteratorFind(itNumStr, (v): v is string => typeof v === 'string');
