...
const i8$1: number | undefined = i8.at(2);
const i8$2: number | undefined = i8.at(-1);

const u8 = new Uint8Array([8, 9, 10]);
const u8$1: number | undefined = u8.at(0);

const u8c = new Uint8ClampedArray([15, 16, 17]);
const u8c$1: number | undefined = u8c.at(2);

const i16 = new Int16Array([100, 200, 300]);
const i16$1: number | undefined = i16.at(1);

const u16 = new Uint16Array([400, 500, 600]);
const u16$1: number | undefined = u16.at(-1);

const i32 = new Int32Array([1, 2, 3]);
const i32$1: number | undefined = i32.at(0);

const u32 = new Uint32Array([7, 8, 9]);
const u32$1: number | undefined = u32.at(2);

const f32 = new Float32Array([1.5, 2.5, 3.5]);
const f32$1: number | undefined = f32.at(-1);
