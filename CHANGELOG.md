...
- Tools, tests, code quality:
  - `core-js-compat` package with data about the necessity of `core-js` modules and API for getting a list of required `core-js` modules by `browserslist` query, [#466](https://github.com/zloirock/core-js/issues/466).
  - `core-js-compat` package also provides information which modules load by each entry point.
