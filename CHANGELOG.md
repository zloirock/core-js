...
- Allowed `rhino` target in `core-js-compat` / `core-js-builder`, added compat data for `rhino` 1.7.13, [#942](https://github.com/zloirock/core-js/issues/942) and [#943](https://github.com/zloirock/core-js/issues/943), thanks [@gausie](https://github.com/gausie)
