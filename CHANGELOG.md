...
- Compat data improvements:
  ...
  - `SuppressedError` and `Symbol.{ dispose , asyncDispose }` marked as [supported from Bun 1.0.23](https://bun.sh/blog/bun-v1.0.23#resource-management-is-now-supported)
