...
```
// global version
npm i core-js@3.0.0-beta.7
// version without global namespace pollution
npm i core-js-pure@3.0.0-beta.7
// bundled global version
npm i core-js-bundle@3.0.0-beta.7
```
...
require('core-js');
```
If you need already bundled version of `core-js`, use `core-js-bundle` `npm` package or a [version of this package from CDN](https://unpkg.com/core-js-bundle@3.0.0-beta.7) ([minified version](https://unpkg.com/core-js-bundle@3.0.0-beta.7/minified.js)).
