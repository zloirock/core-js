...
```
// global version
npm install --save core-js@3.4.3
// version without global namespace pollution
npm install --save core-js-pure@3.4.3
// bundled global version
npm install --save core-js-bundle@3.4.3
```

Already bundled version of `core-js` [on CDN](https://unpkg.com/core-js-bundle@3.4.3) ([minified version](https://unpkg.com/core-js-bundle@3.4.3/minified.js)).
...
`RegExp` features: modules [`es.regexp.constructor`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.regexp.constructor.js) and [`es.regexp.flags`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.regexp.flags.js).
```js
class String {
...
```
#### ECMAScript: Number
Module [`es.number.constructor`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.number.constructor.js). `Number` constructor support binary and octal literals, [*example*](http://goo.gl/jRd6b3):
```js
Number('0b1010101'); // => 85
...
#### Map
Module [`es.map`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.map.js).
```js
class Map {
...
```
#### Set
Module [`es.set`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.set.js).
```js
class Set {
...
```
#### WeakMap
Module [`es.weak-map`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.weak-map.js).
```js
class WeakMap {
...
```
#### WeakSet
Module [`es.weak-set`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.weak-set.js).
```js
class WeakSet {
...
Module [`es.json.to-string-tag`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.json.stringify.js).
```js
namespace JSON {
...
Module [`es.global-this`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/es.global-this.js).
```js
...
Module [`esnext.global-this`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.global-this.js).
```js
let globalThis: Object;
```
[*CommonJS entry points:*](#commonjs-api)
...
Module [`esnext.string.match-all`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.string.match-all.js).
...
Module [`esnext.promise.all-settled`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.promise.all-settled.js)
```js
class Promise {
  static allSettled(iterable: Iterable): Promise;
}
...
Modules [`esnext.promise.any`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.promise.any.js) and [`esnext.aggregate-error`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.aggregate-error.js)
```js
...
Module [`esnext.string.replace-all`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.string.replace-all.js)
```js
class String {
...
Modules [`esnext.symbol.dispose`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.symbol.dispose.js) and [`esnext.symbol.async-dispose`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.symbol.async-dispose.js).
```js
class Symbol {
...
Module [`esnext.array.is-template-object`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.array.is-template-object.js)
```js
class Array {
...
Modules [`esnext.map.upsert`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.map.upsert.js) and [`esnext.weak-map.upsert`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.weak-map.upsert.js)
```js
class Map {
...
Modules [`esnext.array.last-item`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.array.last-item.js) and [`esnext.array.last-index`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.array.last-index.js)
```js
class Array {
...
Module [`esnext.promise.try`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.promise.try.js)
```js
class Promise {
...
Modules [`esnext.composite-key`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.composite-symbol.js)
```js
...
Modules [`esnext.observable`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.symbol.observable.js)
```js
class Observable {
...
Module [`esnext.math.signbit`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.math.signbit.js)
```js
namespace Math {
...
Module [`esnext.number.from-string`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.number.from-string.js)
```js
class Number {
...
Module [`esnext.string.code-points`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.string.code-points.js)
```js
class String {
...
Module [`esnext.math.seeded-prng`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.math.seeded-prng.js)
```js
class Math {
...
Module [`esnext.symbol.pattern-match`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.symbol.pattern-match.js).
```js
class Symbol {
...
Module [`esnext.string.at`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/esnext.string.at.js)
```js
class String {
...
Module [`web.timers`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
```
#### `setImmediate`
Module [`web.immediate`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/web.immediate.js). [`setImmediate`](http://w3c.github.io/setImmediate/) polyfill.
```js
...
#### `queueMicrotask`
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/zloirock/core-js/blob/v3.4.3/packages/core-js/modules/web.queue-microtask.js)
```js
