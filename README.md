...
`RegExp` features: modules [`es.regexp.constructor`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.regexp.constructor.js) and [`es.regexp.flags`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.regexp.flags.js).
```js
class String {
...
```
#### ECMAScript: Number
Module [`es.number.constructor`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.number.constructor.js). `Number` constructor support binary and octal literals, [*example*](http://goo.gl/jRd6b3):
```js
Number('0b1010101'); // => 85
...
#### ECMAScript: Promise
Modules [`es.promise`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.promise.js) and [`es.promise.finally`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.promise.finally.js).
```js
class Promise {
...
#### Map
Module [`es.map`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.map.js).
```js
class Map {
...
```
#### Set
Module [`es.set`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.set.js).
```js
class Set {
...
```
#### WeakMap
Module [`es.weak-map`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.weak-map.js).
```js
class WeakMap {
...
```
#### WeakSet
Module [`es.weak-set`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/es.weak-set.js).
```js
class WeakSet {
...
```
* `String#matchAll` [proposal](https://github.com/tc39/proposal-string-matchall) - module [`esnext.string.match-all`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.string.match-all.js).
...
```
* `globalThis` [proposal](https://github.com/tc39/proposal-global) - module [`esnext.global-this`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.global-this.js).
```js
...
```
* `Promise.allSettled` [proposal](https://github.com/tc39/proposal-promise-allSettled) - module [`esnext.promise.all-settled`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.promise.all-settled.js)
```js
class Promise {
...
```
* `String#replaceAll` [proposal](https://github.com/tc39/proposal-string-replace-all) - module [`esnext.string.replace-all`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.string.replace-all.js)
```js
class String {
...
array; // => [1, 2, 4]
```
* `Promise.try` [proposal](https://github.com/tc39/proposal-promise-try) - module [`esnext.promise.try`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.promise.try.js)
```js
class Promise {
...
```
* `Math.signbit` [proposal](https://github.com/tc39/proposal-Math.signbit) - module [`esnext.math.signbit`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.math.signbit.js)
```js
namespace Math {
...
```
* `Number.fromString` [proposal](https://github.com/tc39/proposal-number-fromstring) - module [`esnext.number.from-string`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.number.from-string.js)
```js
class Number {
...
```
* `String#codePoints` [proposal](https://github.com/tc39/proposal-string-prototype-codepoints) - module [`esnext.string.code-points`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.string.code-points.js)
```js
class String {
...
```
* Seeded pseudo-random numbers [proposal](https://github.com/tc39/proposal-seeded-random) - module [`esnext.math.seeded-prng`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.math.seeded-prng.js)
```js
class Math {
...
```
* `Symbol.patternMatch` for [pattern matching proposal](https://github.com/tc39/proposal-pattern-matching) - module [`esnext.symbol.pattern-match`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.symbol.pattern-match.js).
```js
class Symbol {
...
```
* `Symbol.dispose` for [`using` statement proposal](https://github.com/tc39/proposal-using-statement) - module [`esnext.symbol.dispose`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.symbol.dispose.js).
```js
class Symbol {
...
* `String#at` [proposal](https://github.com/mathiasbynens/String.prototype.at) - module [`esnext.string.at`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/esnext.string.at.js)
```js
class String {
...
Module [`web.timers`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
```
#### `setImmediate`
Module [`web.immediate`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/web.immediate.js). [`setImmediate` proposal](https://developer.mozilla.org/en-US/docs/Web/API/Window.setImmediate) polyfill.
```js
...
#### `queueMicrotask`
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/zloirock/core-js/blob/v3.1.2/packages/core-js/modules/web.queue-microtask.js)
```js
