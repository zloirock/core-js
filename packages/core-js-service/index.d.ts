...
interface Options {
   ...
   *  because it costs about as much as building the bundle again for 12% over gzip */
  compression?: {
    identity?: boolean,
    gzip?: boolean | Readonly<Record<string, unknown>>,
    br?: boolean | Readonly<Record<string, unknown>>,
  };
