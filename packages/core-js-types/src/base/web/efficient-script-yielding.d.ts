 ...
 */
declare function setImmediate(handler: (...args: any[]) => void, ...args: any[]): number | object;

/**
 * Cancels a function scheduled with setImmediate.
 * @param immediate - The identifier of the scheduled function to cancel.
 */
declare function clearImmediate(immediate: number | object | undefined): void; // For compatibility with Node, `undefined` has been added
