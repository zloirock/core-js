...
declare namespace CoreJS {
  ...
  export interface CoreJSAsyncIterator<T, TReturn = undefined, TNext = undefined> {
     ...
     */
    drop(limit: number): CoreJSAsyncIteratorObject<T, undefined, unknown>;
     ...
     * @returns A new `AsyncIterator`
     */
    filter<S extends T>(predicate: (value: T, index: number) => value is S): CoreJSAsyncIteratorObject<S, undefined, unknown>;
    filter(predicate: (value: T, index: number) => unknown): CoreJSAsyncIteratorObject<T, undefined, unknown>;
     ...
     * @returns A new `AsyncIterator`
     */
    take(limit: number): CoreJSAsyncIteratorObject<T, undefined, unknown>;
  ...
  interface CoreJSIterator<T, TReturn = any, TNext = any> extends Iterator<T, TReturn, TNext> {
     ...
     * @returns A new `AsyncIterator` instance
     */
    toAsync(): CoreJSAsyncIteratorObject<T, undefined, unknown>;
  }
}
