...
declare namespace CoreJS {
  ...
  export type SetUnion<T, U> = (other: ReadonlySetLike<U>) => CoreJS.CoreJSSet<T | U>;

  export type SetSymmetricDifference<T, U> = (other: ReadonlySetLike<U>) => CoreJS.CoreJSSet<T | U>;
}
