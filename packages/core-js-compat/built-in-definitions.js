...
const InstanceProperties = map({
  ...
  dotAll: def(null, ['es.regexp.dot-all']),
  ...
  filterReject: def('instance/filter-reject'),
  finally: def(null, [
    'es.promise.finally',
    ...PromiseDependencies,
  ]),
  ...
  getYear: def(null, ['es.date.get-year']),
  ...
  setYear: def(null, ['es.date.set-year']),
  ...
  substr: def(null, ['es.string.substr']),
  ...
  toGMTString: def(null, ['es.date.to-gmt-string']),
