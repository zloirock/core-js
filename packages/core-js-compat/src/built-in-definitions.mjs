...
export const InstanceProperties = {
  anchor: { global: {
    common: { dependencies: 'string/anchor' },
    string: { dependencies: 'string/anchor' },
  } },
  at: {
    common: 'instance/at',
    array: 'array/at',
  ...
  big: { global: {
    common: { dependencies: 'string/big' },
    string: { dependencies: 'string/big' },
  } },
  blink: { global: {
    common: { dependencies: 'string/blink' },
    string: { dependencies: 'string/blink' },
  } },
  bold: { global: {
    common: { dependencies: 'string/bold' },
    string: { dependencies: 'string/bold' },
  } },
  chunks: { global: 'iterator/chunks' },
  clamp: {
    common: 'instance/clamp',
    number: 'instance/clamp',
  },
  codePointAt: {
    common: 'instance/code-point-at',
  ...
  fixed: { global: {
    common: { dependencies: 'string/fixed' },
    string: { dependencies: 'string/fixed' },
  } },
  flags: 'instance/flags',
  flat: 'instance/flat',
  flatMap: { pure: 'instance/flat-map', global: ['array/flat-map', 'iterator/flat-map'] },
  fontcolor: { global: {
    common: { dependencies: 'string/fontcolor' },
    string: { dependencies: 'string/fontcolor' },
  } },
  fontsize: { global: {
    common: { dependencies: 'string/fontsize' },
    string: { dependencies: 'string/fontsize' },
  } },
  ...
  isWellFormed: {
    common: 'instance/is-well-formed',
    string: 'instance/is-well-formed',
  },
  italics: { global: {
    common: { dependencies: 'string/italics' },
    string: { dependencies: 'string/italics' },
  } },
  join: { pure: 'instance/join', global: ['array/join', 'iterator/join'] },
  keys: 'instance/keys',
  lastIndexOf: 'instance/last-index-of',
  link: { global: {
    common: { dependencies: 'string/link' },
    string: { dependencies: 'string/link' },
  } },
  map: { pure: 'instance/map', global: ['array/map', 'iterator/map'] },
  match: { global: {
    common: { dependencies: 'string/match', filters: [['arg-is-string', 0]] },
    string: { dependencies: 'string/match', filters: [['arg-is-string', 0]] },
  } },
  matchAll: {
    common: 'instance/match-all',
    string: 'instance/match-all',
  },
  name: { global: 'function/name' },
  padEnd: {
    common: 'instance/pad-end',
    string: 'string/pad-end',
  },
  padStart: {
    common: 'instance/pad-start',
  ...
  replaceAll: {
    common: 'instance/replace-all',
    string: 'instance/replace-all',
  },
  reverse: 'instance/reverse',
  search: { global: {
    common: { dependencies: 'string/search', filters: [['arg-is-string', 0]] },
  ...
  small: { global: {
    common: { dependencies: 'string/small' },
    string: { dependencies: 'string/small' },
  } },
  ...
  startsWith: {
    common: 'instance/starts-with',
    string: 'instance/starts-with',
  },
  sticky: { global: 'regexp/sticky' },
  strike: { global: {
    common: { dependencies: 'string/strike' },
    string: { dependencies: 'string/strike' },
  } },
  sub: { global: {
    common: { dependencies: 'string/sub' },
    string: { dependencies: 'string/sub' },
  } },
  sup: { global: {
    common: { dependencies: 'string/sup' },
    string: { dependencies: 'string/sup' },
  } },
  ...
  toWellFormed: {
    common: 'instance/to-well-formed',
    string: 'instance/to-well-formed',
  },
  trim: {
    common: 'instance/trim',
    string: 'instance/trim',
  },
  trimEnd: {
    common: 'instance/trim-end',
    string: 'instance/trim-end',
  },
  trimLeft: {
    common: 'instance/trim-left',
    string: 'instance/trim-left',
  },
  trimRight: {
    common: 'instance/trim-right',
    string: 'instance/trim-right',
  },
  trimStart: {
    common: 'instance/trim-start',
