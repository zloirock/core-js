...
- If you want to add a new data for a browser, run in this browser `tests/compat/index.html` (tests and results for the actual release are available at [`Compat Form`](/compat/README.md)) and you will see what `core-js` modules are required for this browser.
