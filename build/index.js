...
(function(){
  var Promise, ref$, list, libraryBlacklist, banner, readFile, writeFile, unlink, basename, dirname, join, webpack, temp;
  Promise = require('../library/fn/promise');
  ref$ = require('./config'), list = ref$.list, libraryBlacklist = ref$.libraryBlacklist, banner = ref$.banner;
  ...
  module.exports = function(arg$){
    ...
    return new Promise(function(resolve, reject){
      (function(){
        var ns, i$, ref$, len$, name, j$, len1$, TARGET, this$ = this;
        for (ns in this) {
          if (this[ns]) {
