...
{readFile} = require \fs
modules    = <[init es5 shortcuts global es6 es6c promise symbol reflect iterator extendedObjectAPI timers immediate function deferred binding object array arrayStatics number string date extendCollections console]>
module.exports = (opt, next)-> let @ = opt
  ...
  import {+iterator} if @reflect or @promise or @extendCollections
