...
{readFile} = require \fs
modules    = <[init framework library es5 resume global immediateInternal es6 es6c promise symbol reflect iterator extendedObjectAPI timers immediate function binding object array arrayStatics number string date extendCollections console]>
