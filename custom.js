...
require('./es6.object.statics');
},{"./es6.object.statics":9}],2:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":7,"./$.assert":2,"./$.ctx":4}],9:[function(require,module,exports){
var $def     = require('./$.def')
