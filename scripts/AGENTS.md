...
- `canon/` (`npm run canon`) - canonical-helper search over the plugin packages and the `@core-js/compat` sources, to run before writing a new function or branch there. Has its own `AGENTS.md` with the command reference
